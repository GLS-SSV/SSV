/****************************************************************************
  ...
  LCC-to-Pad Interface definition
...
{
	public:
		virtual ~LCCPadInterface() {};

		// to Pad
		virtual void RetractOrbiterAccessArm( void ) = 0;
		virtual void ExtendOrbiterAccessArm( bool EmergencyRate ) = 0;
		virtual void RetractGOXVentArm( void ) = 0;
		virtual void ExtendGOXVentArm( void ) = 0;
		virtual void ActivatePreLOSSWS( void ) = 0;
		virtual void DeactivatePreLOSSWS( void ) = 0;
		virtual void ActivatePostLOSSWS( void ) = 0;
		virtual void DeactivatePostLOSSWS( void ) = 0;
		virtual void ActivateFirex( unsigned int sys ) = 0;
		virtual void DeactivateFirex( unsigned int sys ) = 0;
		virtual bool GetFirexState( unsigned int sys ) = 0;
