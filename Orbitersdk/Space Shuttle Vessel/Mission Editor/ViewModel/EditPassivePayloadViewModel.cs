...
{
	class EditPassivePayloadViewModel : EditPayloadViewModel
	{
		public EditPassivePayloadViewModel() : base( PL_VM_TYPE_PASSIVE )
		{
			...
			HasInstalledPayloadOption = Visibility.Hidden;
			return;
		}

		public Mission_PayloadLatch[] Latches { get; set; }

		public static string WindowTitle{ get; } = "Edit Passive Payload";
		...
		public bool PLID_P1_ena
		{
			...
			set
			{
				if (value) Latches[0].PLID = Defs.LONGERON_PASSIVE[0];
		...
		public bool PLID_P2_ena
		{
			...
			set
			{
				if (value) Latches[1].PLID = Defs.LONGERON_PASSIVE[0];
		...
		public bool PLID_P3_ena
		{
			...
			set
			{
				if (value) Latches[2].PLID = Defs.LONGERON_PASSIVE[0];
		...
		public bool PLID_P4_ena
		{
			...
			set
			{
				if (value) Latches[3].PLID = Defs.LONGERON_PASSIVE[0];
		...
		public bool PLID_S1_ena
		{
			...
			set
			{
				if (value) Latches[4].PLID = Defs.LONGERON_PASSIVE[0];
		...
		public bool PLID_S2_ena
		{
			...
			set
			{
				if (value) Latches[5].PLID = Defs.LONGERON_PASSIVE[0];
		...
		public bool PLID_S3_ena
		{
			...
			set
			{
				if (value) Latches[6].PLID = Defs.LONGERON_PASSIVE[0];
		...
		public bool PLID_S4_ena
		{
			...
			set
			{
				if (value) Latches[7].PLID = Defs.LONGERON_PASSIVE[0];
		...
		public bool PLID_K1_ena
		{
			...
			set
			{
				if (value) Latches[8].PLID = Defs.KEEL_PASSIVE[0];
		...
		public bool PLID_K2_ena
		{
			...
			set
			{
				if (value) Latches[9].PLID = Defs.KEEL_PASSIVE[0];
		...
		public bool PLID_K3_ena
		{
			...
			set
			{
				if (value) Latches[10].PLID = Defs.KEEL_PASSIVE[0];
		...
		public bool PLID_K4_ena
		{
			...
			set
			{
				if (value) Latches[11].PLID = Defs.KEEL_PASSIVE[0];
		...
		void EditLatchCommand( object parameter )
		{
			switch (parameter)
			{
				case "P1":
					{
						EditLatchViewModel editlatchvm = new EditLatchViewModel( 1, false, Defs.LONGERON_PASSIVE, Defs.LONGERON_PASSIVE );
				...
				case "K1":
					{
						EditLatchViewModel editlatchvm = new EditLatchViewModel( 1, true, Defs.KEEL_PASSIVE, Defs.KEEL_PASSIVE );
