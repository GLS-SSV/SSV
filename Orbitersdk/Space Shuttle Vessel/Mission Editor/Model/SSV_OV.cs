...
namespace SSVMissionEditor.Model
{
	...
	public class SSV_OV : OrbiterVessel
	{
		...
		private void Panel_R14( MissionPhase missionphase )
		{
			...
			{
				case MissionPhase.Preview:
					panelblock.switch_pos.Add( Tuple.Create( "MNC MDU CDR 1", "OPEN" ) );
					panelblock.switch_pos.Add( Tuple.Create( "MNB MDU CDR 2", "OPEN" ) );
					panelblock.switch_pos.Add( Tuple.Create( "MNB MDU MFD 1", "OPEN" ) );
					panelblock.switch_pos.Add( Tuple.Create( "MNA MDU MFD 2", "OPEN" ) );
					panelblock.switch_pos.Add( Tuple.Create( "MNA MDU PLT 1", "OPEN" ) );
					panelblock.switch_pos.Add( Tuple.Create( "MNC MDU PLT 2", "OPEN" ) );
					panelblock.switch_pos.Add( Tuple.Create( "MNC MDU AFD 1", "OPEN" ) );
					panelblock.switch_pos.Add( Tuple.Create( "MNA ADC 1A 2A", "OPEN" ) );
					panelblock.switch_pos.Add( Tuple.Create( "MNB ADC 1B 2B", "OPEN" ) );
