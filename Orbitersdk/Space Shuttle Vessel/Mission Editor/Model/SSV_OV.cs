...
namespace SSVMissionEditor.Model
{
	...
	public class SSV_OV : OrbiterVessel
	{
		...
		public override void PreSave( MissionPhase missionphase )
		{
			...
			switch (missionphase)
			{
				case MissionPhase.Preview:
					...
					prplevel.Clear();
					prplevel.Add( Tuple.Create( 0, 0.0 ) );// LOMS
					prplevel.Add( Tuple.Create( 1, 0.0 ) );// ROMS
					// OMS kit
					prplevel.Add( Tuple.Create( 3, 0.0 ) );// FRCS
					prplevel.Add( Tuple.Create( 4, 0.0 ) );// LRCS
					prplevel.Add( Tuple.Create( 5, 0.0 ) );// RRCS
					prplevel.Add( Tuple.Create( 6, 0.0 ) );// MPS
		...
		private void Subsystems( MissionPhase missionphase )
		{
			HeSys( missionphase );
			MPS( missionphase );
			SSME( missionphase );
			...
			RA( missionphase );
			PLB( missionphase );
			LandingGear( missionphase );
			AeroSurfaces( missionphase );
			OMS( missionphase );
			DDU( missionphase );
			HUD( missionphase );
			Controllers( missionphase );
			APU( missionphase );
			WSB( missionphase );
			PayloadLatches( missionphase );
			PRSD( missionphase );
			VCU( missionphase );
			ACA( missionphase );
			STDoors( missionphase );
			VentDoors( missionphase );
			CW( missionphase );
			Sills( missionphase );
			Airlocks( missionphase );
			KuAntenna( missionphase );
			DragChute( missionphase );
			UpperStages( missionphase );
			return;
		}

		private void HeSys( MissionPhase missionphase )
		{
			...
			switch (missionphase)
			{
				case MissionPhase.Preview:
					...
					subsysblock.param_val.Add( Tuple.Create( "PRESS", "0.000000" ) );
					subsysblock.param_val.Add( Tuple.Create( "VALVES", "0.000000 0.000000 0.000000 0.000000" ) );
					...
					subsysblock.param_val.Add( Tuple.Create( "PRESS", "0.000000" ) );
					subsysblock.param_val.Add( Tuple.Create( "VALVES", "0.000000 0.000000 0.000000" ) );
					subsys.Add( subsysblock );
					break;
		...
		private void MPS( MissionPhase missionphase )
		{
			SSVSubsystemBlock subsysblock = new SSVSubsystemBlock{name = "MPS", param_val = new List<Tuple<string,string>>()};
			subsys.Add( subsysblock );
			return;
		}

		private void SSME( MissionPhase missionphase )
		{
			SSVSubsystemBlock subsysblock;
			...
			switch (missionphase)
			{
				case MissionPhase.Preview:
					...
					subsysblock.param_val.Add( Tuple.Create( "SSME config", "5" ) );
					subsysblock.param_val.Add( Tuple.Create( "VIE config", "1" ) );
					subsysblock.param_val.Add( Tuple.Create( "DCU_chA config", "0" ) );
					subsysblock.param_val.Add( Tuple.Create( "DCU_chB config", "0" ) );
					subsysblock.param_val.Add( Tuple.Create( "CIE_chA config", "2" ) );
					subsysblock.param_val.Add( Tuple.Create( "CIE_chB config", "2" ) );
					subsys.Add( subsysblock );
		...
		private void MPC( MissionPhase missionphase )
		{
			SSVSubsystemBlock subsysblock = new SSVSubsystemBlock{name = "MPC1", param_val = new List<Tuple<string,string>>()};
		...
		private void MCA( MissionPhase missionphase )
		{
			SSVSubsystemBlock subsysblock = new SSVSubsystemBlock{name = "FMC1", param_val = new List<Tuple<string,string>>()};
			subsys.Add( subsysblock );
		...
		private void EIU( MissionPhase missionphase )
		{
			SSVSubsystemBlock subsysblock = new SSVSubsystemBlock{name = "EIU1", param_val = new List<Tuple<string,string>>()};
			subsys.Add( subsysblock );
		...
		private void MTU( MissionPhase missionphase )
		{
			SSVSubsystemBlock subsysblock = new SSVSubsystemBlock{name = "MTU", param_val = new List<Tuple<string,string>>()};
		...
		private void IDP( MissionPhase missionphase )
		{
			SSVSubsystemBlock subsysblock;
		...
		private void ADC( MissionPhase missionphase )
		{
			SSVSubsystemBlock subsysblock = new SSVSubsystemBlock{name = "ADC1A", param_val = new List<Tuple<string,string>>()};
			subsys.Add( subsysblock );
		...
		private void GPC( MissionPhase missionphase )
		{
			SSVSubsystemBlock subsysblock;
			...
			{
				case MissionPhase.Preview:
					subsysblock = new SSVSubsystemBlock{name = "SimpleGPC1", param_val = new List<Tuple<string,string>>(), gpcsw = new List<SSVSimpleGPCSoftwareBlock>()};
					// COMPOOL vars
		...
		private void MDM( MissionPhase missionphase )
		{
			SSVSubsystemBlock subsysblock = new SSVSubsystemBlock{name = "MDM_FF1", param_val = new List<Tuple<string,string>>()};
		...
		private void ADP( MissionPhase missionphase )
		{
			SSVSubsystemBlock subsysblock = new SSVSubsystemBlock{name = "AirDataProbes", param_val = new List<Tuple<string,string>>()};
		...
		private void ETUD( MissionPhase missionphase )
		{
			SSVSubsystemBlock subsysblock = new SSVSubsystemBlock{name = "ETUmbilicalDoors", param_val = new List<Tuple<string,string>>()};
		...
		private void GCIL( MissionPhase missionphase )
		{
			SSVSubsystemBlock subsysblock = new SSVSubsystemBlock{name = "GCIL", param_val = new List<Tuple<string,string>>()};
			subsys.Add( subsysblock );
			return;
		}

		private void TVC( MissionPhase missionphase )
		{
			SSVSubsystemBlock subsysblock = new SSVSubsystemBlock{name = "ATVC", param_val = new List<Tuple<string,string>>()};
			subsys.Add( subsysblock );
		...
		private void MEC( MissionPhase missionphase )
		{
			SSVSubsystemBlock subsysblock = new SSVSubsystemBlock{name = "MEC1", param_val = new List<Tuple<string,string>>()};
			subsys.Add( subsysblock );
		...
		private void RA( MissionPhase missionphase )
		{
			SSVSubsystemBlock subsysblock = new SSVSubsystemBlock{name = "RA1", param_val = new List<Tuple<string,string>>()};
			subsys.Add( subsysblock );
		...
		private void LandingGear( MissionPhase missionphase )
		{
			SSVSubsystemBlock subsysblock = new SSVSubsystemBlock{name = "LandingGear", param_val = new List<Tuple<string,string>>()};
		...
		private void AeroSurfaces( MissionPhase missionphase )
		{
			SSVSubsystemBlock subsysblock = new SSVSubsystemBlock{name = "AeroSurfaces", param_val = new List<Tuple<string,string>>()};
		...
		private void OMS( MissionPhase missionphase )
		{
			SSVSubsystemBlock subsysblock = new SSVSubsystemBlock{name = "OMS_LEFT", param_val = new List<Tuple<string,string>>()};
			subsys.Add( subsysblock );
		...
		private void DDU( MissionPhase missionphase )
		{
			SSVSubsystemBlock subsysblock = new SSVSubsystemBlock{name = "DDU1", param_val = new List<Tuple<string,string>>()};
			subsys.Add( subsysblock );
		...
		private void HUD( MissionPhase missionphase )
		{
			SSVSubsystemBlock subsysblock = new SSVSubsystemBlock{name = "HUD1", param_val = new List<Tuple<string,string>>()};
		...
		private void Controllers( MissionPhase missionphase )
		{
			SSVSubsystemBlock subsysblock = new SSVSubsystemBlock{name = "LeftRHC", param_val = new List<Tuple<string,string>>()};
			subsys.Add( subsysblock );
		...
		private void APU( MissionPhase missionphase )
		{
			SSVSubsystemBlock subsysblock;
			...
			switch (missionphase)
			{
				case MissionPhase.Preview:
					...
					subsysblock.param_val.Add( Tuple.Create( "FuelMass", "0.000000" ) );
		...
		private void WSB( MissionPhase missionphase )
		{
			SSVSubsystemBlock subsysblock = new SSVSubsystemBlock{name = "WSB1", param_val = new List<Tuple<string,string>>()};
			subsys.Add( subsysblock );
		...
		private void PayloadLatches( MissionPhase missionphase )
		{
			for (int i = 0, k = 1; i < 5; i++)
			{
				if (mission.OV.PL_Active[i].IsUsed)
				{
					SSVSubsystemBlock subsysblock = new SSVSubsystemBlock{name = "Payload_Latch_" + k, param_val = new List<Tuple<string,string>>()};
		...
		private void PRSD( MissionPhase missionphase )
		{
			SSVSubsystemBlock subsysblock = new SSVSubsystemBlock{name = "PRSD", param_val = new List<Tuple<string,string>>()};

			switch (missionphase)
			{
				case MissionPhase.Preview:
					subsysblock.param_val.Add( Tuple.Create( "LV011", "0.000000" ) );
					subsysblock.param_val.Add( Tuple.Create( "LV021", "0.000000" ) );
					subsysblock.param_val.Add( Tuple.Create( "LV031", "0.000000" ) );
					subsysblock.param_val.Add( Tuple.Create( "LV041", "0.000000" ) );
					subsysblock.param_val.Add( Tuple.Create( "LV013", "0.000000" ) );
					subsysblock.param_val.Add( Tuple.Create( "LV023", "0.000000" ) );
					subsysblock.param_val.Add( Tuple.Create( "LV024", "0.000000" ) );
					subsysblock.param_val.Add( Tuple.Create( "LV033", "0.000000" ) );
					subsysblock.param_val.Add( Tuple.Create( "LV043", "0.000000" ) );
					subsysblock.param_val.Add( Tuple.Create( "LV044", "0.000000" ) );
					subsysblock.param_val.Add( Tuple.Create( "LV012", "0.000000" ) );
					subsysblock.param_val.Add( Tuple.Create( "LV022", "0.000000" ) );
					break;
				case MissionPhase.LaunchT20m:
				case MissionPhase.LaunchT9m:
				case MissionPhase.LaunchT31s:
		...
		private void VCU( MissionPhase missionphase )
		{
			SSVSubsystemBlock subsysblock = new SSVSubsystemBlock{name = "VideoControlUnit", param_val = new List<Tuple<string,string>>()};
		...
		private void ACA( MissionPhase missionphase )
		{
			SSVSubsystemBlock subsysblock = new SSVSubsystemBlock{name = "ACA1", param_val = new List<Tuple<string,string>>()};
			subsys.Add( subsysblock );
		...
		private void STDoors( MissionPhase missionphase )
		{
			SSVSubsystemBlock subsysblock = new SSVSubsystemBlock{name = "StarTrackerDoors", param_val = new List<Tuple<string,string>>()};
		...
		private void VentDoors( MissionPhase missionphase )
		{
			SSVSubsystemBlock subsysblock = new SSVSubsystemBlock{name = "VentDoors", param_val = new List<Tuple<string,string>>()};

			switch (missionphase)
			{
				case MissionPhase.Preview:
					subsysblock.param_val.Add( Tuple.Create( "LEFT_1/2", "0.000000" ) );
					...
					subsysblock.param_val.Add( Tuple.Create( "RIGHT_1/2", "0.000000" ) );
		...
		private void CW( MissionPhase missionphase )
		{
			SSVSubsystemBlock subsysblock;
			...
			{
				case MissionPhase.Preview:
					subsysblock = new SSVSubsystemBlock{name = "PrimaryCaution&Warning", param_val = new List<Tuple<string,string>>()};
					{
						// inhibited params
		...
		private void Sills( MissionPhase missionphase )
		{
			SSVSubsystemBlock subsysblock;
		...
		private void Airlocks( MissionPhase missionphase )
		{
			SSVSubsystemBlock subsysblock;
		...
		private void KuAntenna( MissionPhase missionphase )
		{
			SSVSubsystemBlock subsysblock;
		...
		private void DragChute( MissionPhase missionphase )
		{
			SSVSubsystemBlock subsysblock;
		...
		private void UpperStages( MissionPhase missionphase )
		{
			SSVSubsystemBlock subsysblock;
		...
		private void Panels( MissionPhase missionphase )
		{
			//// Forward
			Panel_F2( missionphase );
			Panel_F3( missionphase );
			Panel_F4( missionphase );
			Panel_F6( missionphase );
			Panel_F7( missionphase );
			Panel_F8( missionphase );
			// F9

			//// Left
			Panel_L1( missionphase );
			Panel_L2( missionphase );
			// L4

			//// Center
			Panel_C2( missionphase );
			Panel_C3( missionphase );

			//// Right
			Panel_R2( missionphase );
			Panel_R1( missionphase );
			// R4

			//// Overhead
			Panel_O1( missionphase );
			Panel_O2( missionphase );
			Panel_O3( missionphase );
			// O5
			Panel_O6( missionphase );
			Panel_O7( missionphase );
			Panel_O8( missionphase );
			// O9

			//// Overhead aft
			Panel_O13( missionphase );
			Panel_O14( missionphase );
			Panel_O15( missionphase );
			Panel_O16( missionphase );
			Panel_O17( missionphase );

			//// Overhead aft
			// L9
			Panel_L10( missionphase );
			Panel_L12( missionphase );

			//// Aft
			Panel_A1U( missionphase );
			// A1L
			// A1R
			Panel_AFD( missionphase );
			Panel_A2( missionphase );
			Panel_A3( missionphase );
			Panel_A4( missionphase );
			Panel_A6U( missionphase );
			Panel_A6L( missionphase );
			Panel_A7U( missionphase );
			Panel_A7L( missionphase );
			Panel_A8U( missionphase );
			Panel_A8L( missionphase );

			//// Right
			// R10
			Panel_R11U( missionphase );
			Panel_R11L( missionphase );
			Panel_R13U( missionphase );
			Panel_R13L( missionphase );
			Panel_R14( missionphase );
			return;
		}

		private void Panel_F2( MissionPhase missionphase )
		{
			SSVPanelBlock panelblock = new SSVPanelBlock{name = "F2", obj = new List<SSVscnObject>(), switch_pos = new List<Tuple<string,string>>()};
			if (mission.OV.DragChute)
			{
		...
		private void Panel_F3( MissionPhase missionphase )
		{
			SSVPanelBlock panelblock = new SSVPanelBlock{name = "F3", obj = new List<SSVscnObject>(), switch_pos = new List<Tuple<string,string>>()};;

			switch (missionphase)
			{
				case MissionPhase.Preview:
					panelblock.switch_pos.Add( Tuple.Create( "TRIM RHC/PNL CDR", "INHIBIT" ) );
					panelblock.switch_pos.Add( Tuple.Create( "TRIM PANEL CDR", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "TRIM RHC/PNL PLT", "INHIBIT" ) );
					panelblock.switch_pos.Add( Tuple.Create( "TRIM PANEL PLT", "OFF" ) );
		...
		private void Panel_F4( MissionPhase missionphase )
		{
			SSVPanelBlock panelblock = new SSVPanelBlock{name = "F4", obj = new List<SSVscnObject>(), switch_pos = new List<Tuple<string,string>>()};
			if (mission.OV.DragChute) panelblock.switch_pos.Add( Tuple.Create( "DRAG CHUTE JETT COVER", "CLOSED" ) );
			panels.Add( panelblock );
			return;
		}

		private void Panel_F6( MissionPhase missionphase )
		{
			SSVPanelBlock panelblock = new SSVPanelBlock{name = "F6", obj = new List<SSVscnObject>(), switch_pos = new List<Tuple<string,string>>()};
		...
		private void Panel_F7( MissionPhase missionphase )
		{
			SSVPanelBlock panelblock = new SSVPanelBlock{name = "F7", obj = new List<SSVscnObject>(), switch_pos = new List<Tuple<string,string>>()};
			SSVscnObject panelobject;
		...
		private void Panel_F8( MissionPhase missionphase )
		{
			SSVPanelBlock panelblock = new SSVPanelBlock{name = "F8", obj = new List<SSVscnObject>(), switch_pos = new List<Tuple<string,string>>()};
			SSVscnObject panelobject;
		...
		private void Panel_L1( MissionPhase missionphase )
		{
			SSVPanelBlock panelblock = new SSVPanelBlock{name = "L1", obj = new List<SSVscnObject>(), switch_pos = new List<Tuple<string,string>>()};
		...
		private void Panel_L2( MissionPhase missionphase )
		{
			SSVPanelBlock panelblock = new SSVPanelBlock{name = "L2", obj = new List<SSVscnObject>(), switch_pos = new List<Tuple<string,string>>()};

			switch (missionphase)
			{
				case MissionPhase.Preview:
					panelblock.switch_pos.Add( Tuple.Create( "ANTISKID", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "NOSE WHEEL STEERING", "OFF" ) );
		...
		private void Panel_C2( MissionPhase missionphase )
		{
			SSVPanelBlock panelblock = new SSVPanelBlock{name = "C2", obj = new List<SSVscnObject>(), switch_pos = new List<Tuple<string,string>>()};

			switch (missionphase)
			{
				case MissionPhase.Preview:
					panelblock.switch_pos.Add( Tuple.Create( "IDP/CRT 1 POWER", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "IDP/CRT 2 POWER", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "IDP/CRT 3 POWER", "OFF" ) );
		...
		private void Panel_C3( MissionPhase missionphase )
		{
			SSVPanelBlock panelblock = new SSVPanelBlock{name = "C3", obj = new List<SSVscnObject>(), switch_pos = new List<Tuple<string,string>>()};

			switch (missionphase)
			{
				case MissionPhase.Preview:
					panelblock.switch_pos.Add( Tuple.Create( "OMS ENG LEFT", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "OMS ENG RIGHT", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "BFC CRT DISPLAY", "OFF" ) );
		...
		private void Panel_R1( MissionPhase missionphase )
		{
			SSVPanelBlock panelblock = new SSVPanelBlock{name = "R1", obj = new List<SSVscnObject>(), switch_pos = new List<Tuple<string,string>>()};
			...
			switch (missionphase)
			{
				case MissionPhase.Preview:;
					...
					panelblock.switch_pos.Add( Tuple.Create( "AC BUS SNSR 1", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "AC BUS SNSR 2", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "AC BUS SNSR 3", "OFF" ) );
					...
					panelblock.switch_pos.Add( Tuple.Create( "O2 TK1 HEATERS A", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "O2 TK1 HEATERS B", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "O2 TK2 HEATERS A", "OFF" ) );
					...
					panelblock.switch_pos.Add( Tuple.Create( "H2 TK1 HEATERS A", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "H2 TK1 HEATERS B", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "H2 TK2 HEATERS A", "OFF" ) );
		...
		private void Panel_R2( MissionPhase missionphase )
		{
			SSVPanelBlock panelblock = new SSVPanelBlock{name = "R2", obj = new List<SSVscnObject>(), switch_pos = new List<Tuple<string,string>>()};
			...
			switch (missionphase)
			{
				case MissionPhase.Preview:
					...
					panelblock.switch_pos.Add( Tuple.Create( "MPS ENGINE POWER LEFT AC2", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "MPS ENGINE POWER CTR AC1", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "MPS ENGINE POWER RIGHT AC3", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "MPS ENGINE POWER LEFT AC3", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "MPS ENGINE POWER CTR AC2", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "MPS ENGINE POWER RIGHT AC1", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "MPS He ISOLATION A LEFT", "CLOSED" ) );
					panelblock.switch_pos.Add( Tuple.Create( "MPS He ISOLATION A CTR", "CLOSED" ) );
					panelblock.switch_pos.Add( Tuple.Create( "MPS He ISOLATION A RIGHT", "CLOSED" ) );
					panelblock.switch_pos.Add( Tuple.Create( "MPS He ISOLATION B LEFT", "CLOSED" ) );
					panelblock.switch_pos.Add( Tuple.Create( "MPS He ISOLATION B CTR", "CLOSED" ) );
					panelblock.switch_pos.Add( Tuple.Create( "MPS He ISOLATION B RIGHT", "CLOSED" ) );
					panelblock.switch_pos.Add( Tuple.Create( "MPS PNEUMATICS L ENG He XOVR", "CLOSED" ) );
					panelblock.switch_pos.Add( Tuple.Create( "MPS PNEUMATICS He ISOL", "CLOSED" ) );
					panelblock.switch_pos.Add( Tuple.Create( "MPS He INTERCONNECT LEFT", "CLOSED" ) );
					panelblock.switch_pos.Add( Tuple.Create( "MPS He INTERCONNECT CTR", "CLOSED" ) );
					panelblock.switch_pos.Add( Tuple.Create( "MPS He INTERCONNECT RIGHT", "CLOSED" ) );
					...
					panelblock.switch_pos.Add( Tuple.Create( "BOILER CNTLR/HTR 1", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "BOILER CNTLR/HTR 2", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "BOILER CNTLR/HTR 3", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "BOILER PWR 1", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "BOILER PWR 2", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "BOILER PWR 3", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "BOILER N2 SUPPLY 1", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "BOILER N2 SUPPLY 2", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "BOILER N2 SUPPLY 3", "OFF" ) );
		...
		private void Panel_O1( MissionPhase missionphase )
		{
			SSVPanelBlock panelblock = new SSVPanelBlock{name = "O1", obj = new List<SSVscnObject>(), switch_pos = new List<Tuple<string,string>>()};
			panels.Add( panelblock );
			return;
		}

		private void Panel_O2( MissionPhase missionphase )
		{
			SSVPanelBlock panelblock = new SSVPanelBlock{name = "O2", obj = new List<SSVscnObject>(), switch_pos = new List<Tuple<string,string>>()};
		...
		private void Panel_O3( MissionPhase missionphase )
		{
			SSVPanelBlock panelblock = new SSVPanelBlock{name = "O3", obj = new List<SSVscnObject>(), switch_pos = new List<Tuple<string,string>>()};
		...
		private void Panel_O6( MissionPhase missionphase )
		{
			SSVPanelBlock panelblock = new SSVPanelBlock{name = "O6", obj = new List<SSVscnObject>(), switch_pos = new List<Tuple<string,string>>()};
			...
			switch (missionphase)
			{
				case MissionPhase.Preview:
					...
					panelblock.switch_pos.Add( Tuple.Create( "MDM PL1", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "MDM PL2", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "MDM PL3", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "MDM FA1", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "MDM FA2", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "MDM FA3", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "MDM FA4", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "MDM FF1", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "MDM FF2", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "MDM FF3", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "MDM FF4", "OFF" ) );
					...
					panelblock.switch_pos.Add( Tuple.Create( "GPC POWER 1", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "GPC POWER 2", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "GPC POWER 3", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "GPC POWER 4", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "GPC POWER 5", "OFF" ) );
					...
					panelblock.switch_pos.Add( Tuple.Create( "GPC OUTPUT 1", "TERMINATE" ) );
					panelblock.switch_pos.Add( Tuple.Create( "GPC OUTPUT 2", "TERMINATE" ) );
					panelblock.switch_pos.Add( Tuple.Create( "GPC OUTPUT 3", "TERMINATE" ) );
					panelblock.switch_pos.Add( Tuple.Create( "GPC OUTPUT 4", "TERMINATE" ) );
					panelblock.switch_pos.Add( Tuple.Create( "GPC OUTPUT 5", "TERMINATE" ) );
					panelblock.switch_pos.Add( Tuple.Create( "IPL SOURCE", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "GPC MODE 1", "HALT" ) );
					panelblock.switch_pos.Add( Tuple.Create( "GPC MODE 2", "HALT" ) );
					panelblock.switch_pos.Add( Tuple.Create( "GPC MODE 3", "HALT" ) );
					panelblock.switch_pos.Add( Tuple.Create( "GPC MODE 4", "HALT" ) );
					panelblock.switch_pos.Add( Tuple.Create( "GPC MODE 5", "HALT" ) );
					break;
				case MissionPhase.LaunchT20m:
					break;
				case MissionPhase.LaunchT9m:
		...
		private void Panel_O7( MissionPhase missionphase )
		{
			SSVPanelBlock panelblock = new SSVPanelBlock{name = "O8", obj = new List<SSVscnObject>(), switch_pos = new List<Tuple<string,string>>()};

			switch (missionphase)
			{
				case MissionPhase.Preview:
					panelblock.switch_pos.Add( Tuple.Create( "AFT LEFT RCS He PRESS A", "CLOSE" ) );
					panelblock.switch_pos.Add( Tuple.Create( "AFT LEFT RCS He PRESS B", "CLOSE" ) );
					panelblock.switch_pos.Add( Tuple.Create( "AFT LEFT RCS TANK ISOLATION 1/2", "CLOSE" ) );
					panelblock.switch_pos.Add( Tuple.Create( "AFT LEFT RCS TANK ISOLATION 3/4/5 A", "CLOSE" ) );
					panelblock.switch_pos.Add( Tuple.Create( "AFT LEFT RCS TANK ISOLATION 3/4/5 B", "CLOSE" ) );
					panelblock.switch_pos.Add( Tuple.Create( "AFT LEFT RCS MANIFOLD ISOLATION 1", "CLOSE" ) );
					panelblock.switch_pos.Add( Tuple.Create( "AFT LEFT RCS MANIFOLD ISOLATION 2", "CLOSE" ) );
					panelblock.switch_pos.Add( Tuple.Create( "AFT LEFT RCS MANIFOLD ISOLATION 3", "CLOSE" ) );
					panelblock.switch_pos.Add( Tuple.Create( "AFT LEFT RCS MANIFOLD ISOLATION 4", "CLOSE" ) );
					panelblock.switch_pos.Add( Tuple.Create( "AFT LEFT RCS MANIFOLD ISOLATION 5", "CLOSE" ) );
					panelblock.switch_pos.Add( Tuple.Create( "AFT RIGHT RCS He PRESS A", "CLOSE" ) );
					panelblock.switch_pos.Add( Tuple.Create( "AFT RIGHT RCS He PRESS B", "CLOSE" ) );
					panelblock.switch_pos.Add( Tuple.Create( "AFT RIGHT RCS TANK ISOLATION 1/2", "CLOSE" ) );
					panelblock.switch_pos.Add( Tuple.Create( "AFT RIGHT RCS TANK ISOLATION 3/4/5 A", "CLOSE" ) );
					panelblock.switch_pos.Add( Tuple.Create( "AFT RIGHT RCS TANK ISOLATION 3/4/5 B", "CLOSE" ) );
					panelblock.switch_pos.Add( Tuple.Create( "AFT RIGHT RCS MANIFOLD ISOLATION 1", "CLOSE" ) );
					panelblock.switch_pos.Add( Tuple.Create( "AFT RIGHT RCS MANIFOLD ISOLATION 2", "CLOSE" ) );
					panelblock.switch_pos.Add( Tuple.Create( "AFT RIGHT RCS MANIFOLD ISOLATION 3", "CLOSE" ) );
					panelblock.switch_pos.Add( Tuple.Create( "AFT RIGHT RCS MANIFOLD ISOLATION 4", "CLOSE" ) );
					panelblock.switch_pos.Add( Tuple.Create( "AFT RIGHT RCS MANIFOLD ISOLATION 5", "CLOSE" ) );
					panelblock.switch_pos.Add( Tuple.Create( "LEFT RCS CROSSFEED 1/2", "CLOSE" ) );
					panelblock.switch_pos.Add( Tuple.Create( "LEFT RCS CROSSFEED 3/4/5", "CLOSE" ) );
					panelblock.switch_pos.Add( Tuple.Create( "RIGHT RCS CROSSFEED 1/2", "CLOSE" ) );
					panelblock.switch_pos.Add( Tuple.Create( "RIGHT RCS CROSSFEED 3/4/5", "CLOSE" ) );
					panelblock.switch_pos.Add( Tuple.Create( "MASTER RCS CROSSFEED", "CLOSE" ) );
					break;
				case MissionPhase.LaunchT20m:
					break;
				case MissionPhase.LaunchT9m:
		...
		private void Panel_O8( MissionPhase missionphase )
		{
			SSVPanelBlock panelblock = new SSVPanelBlock{name = "O8", obj = new List<SSVscnObject>(), switch_pos = new List<Tuple<string,string>>()};
			...
			{
				case MissionPhase.Preview:
					panelblock.switch_pos.Add( Tuple.Create( "RADAR ALTIMETER 1", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "RADAR ALTIMETER 2", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "OMS KIT He PRESS/VAPOR ISOL A", "CLOSE" ) );
					panelblock.switch_pos.Add( Tuple.Create( "OMS KIT He PRESS/VAPOR ISOL B", "CLOSE" ) );
					panelblock.switch_pos.Add( Tuple.Create( "OMS KIT TANK ISOLATION A", "CLOSE" ) );
					panelblock.switch_pos.Add( Tuple.Create( "OMS KIT TANK ISOLATION B", "CLOSE" ) );
					panelblock.switch_pos.Add( Tuple.Create( "LEFT OMS He PRESS/VAPOR ISOL A", "CLOSE" ) );
					panelblock.switch_pos.Add( Tuple.Create( "LEFT OMS He PRESS/VAPOR ISOL B", "CLOSE" ) );
					panelblock.switch_pos.Add( Tuple.Create( "LEFT OMS TANK ISOLATION A", "CLOSE" ) );
					panelblock.switch_pos.Add( Tuple.Create( "LEFT OMS TANK ISOLATION B", "CLOSE" ) );
					panelblock.switch_pos.Add( Tuple.Create( "RIGHT OMS He PRESS/VAPOR ISOL A", "CLOSEC" ) );
					panelblock.switch_pos.Add( Tuple.Create( "RIGHT OMS He PRESS/VAPOR ISOL B", "CLOSE" ) );
					panelblock.switch_pos.Add( Tuple.Create( "RIGHT OMS TANK ISOLATION A", "CLOSEPC" ) );
					panelblock.switch_pos.Add( Tuple.Create( "RIGHT OMS TANK ISOLATION B", "CLOSEPC" ) );
					panelblock.switch_pos.Add( Tuple.Create( "LEFT OMS CROSSFEED A", "CLOSE" ) );
					panelblock.switch_pos.Add( Tuple.Create( "LEFT OMS CROSSFEED B", "CLOSE" ) );
					panelblock.switch_pos.Add( Tuple.Create( "RIGHT OMS CROSSFEED A", "CLOSE" ) );
					panelblock.switch_pos.Add( Tuple.Create( "RIGHT OMS CROSSFEED B", "CLOSE" ) );
					panelblock.switch_pos.Add( Tuple.Create( "FWD RCS He PRESS A", "CLOSE" ) );
					panelblock.switch_pos.Add( Tuple.Create( "FWD RCS He PRESS B", "CLOSE" ) );
					panelblock.switch_pos.Add( Tuple.Create( "FWD RCS TANK ISOLATION 1/2", "CLOSE" ) );
					panelblock.switch_pos.Add( Tuple.Create( "FWD RCS TANK ISOLATION 3/4/5", "CLOSE" ) );
					panelblock.switch_pos.Add( Tuple.Create( "FWD RCS MANIFOLD ISOLATION 1", "CLOSE" ) );
					panelblock.switch_pos.Add( Tuple.Create( "FWD RCS MANIFOLD ISOLATION 2", "CLOSE" ) );
					panelblock.switch_pos.Add( Tuple.Create( "FWD RCS MANIFOLD ISOLATION 3", "CLOSE" ) );
					panelblock.switch_pos.Add( Tuple.Create( "FWD RCS MANIFOLD ISOLATION 4", "CLOSE" ) );
					panelblock.switch_pos.Add( Tuple.Create( "FWD RCS MANIFOLD ISOLATION 5", "CLOSE" ) );
					break;
				case MissionPhase.LaunchT20m:
					break;
				case MissionPhase.LaunchT9m:
		...
		private void Panel_O13( MissionPhase missionphase )
		{
			SSVPanelBlock panelblock = new SSVPanelBlock{name = "O13", obj = new List<SSVscnObject>(), switch_pos = new List<Tuple<string,string>>()};

			switch (missionphase)
			{
				case MissionPhase.Preview:
					panelblock.switch_pos.Add( Tuple.Create( "C&W A", "OPEN" ) );
					panelblock.switch_pos.Add( Tuple.Create( "C&W B", "OPEN" ) );
					break;
				case MissionPhase.LaunchT20m:
					break;
				case MissionPhase.LaunchT9m:
		...
		private void Panel_O14( MissionPhase missionphase )
		{
			SSVPanelBlock panelblock = new SSVPanelBlock{name = "O14", obj = new List<SSVscnObject>(), switch_pos = new List<Tuple<string,string>>()};

			switch (missionphase)
			{
				case MissionPhase.Preview:
					panelblock.switch_pos.Add( Tuple.Create( "BRAKES MN A", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "MDM OF 1/2 A", "OPEN" ) );
					panelblock.switch_pos.Add( Tuple.Create( "MDM OF 3/4 A", "OPEN" ) );
					panelblock.switch_pos.Add( Tuple.Create( "STAR TRKR -Z", "OPEN" ) );
					panelblock.switch_pos.Add( Tuple.Create( "DDU LEFT MN A", "OPEN" ) );
					panelblock.switch_pos.Add( Tuple.Create( "DDU AFT MN A", "OPEN" ) );
					panelblock.switch_pos.Add( Tuple.Create( "NOSE WHEEL STEERING MN A", "OPEN" ) );
					panelblock.switch_pos.Add( Tuple.Create( "RJDA 1A LOGIC", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "RJDA 1A DRIVER", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "RJDA 2A LOGIC", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "RJDA 2A DRIVER", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "RJDF 1B LOGIC", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "RJDF 1B DRIVER", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "L OMS ENG VLV", "OFF" ) );
					break;
				case MissionPhase.LaunchT20m:
					break;
				case MissionPhase.LaunchT9m:
		...
		private void Panel_O15( MissionPhase missionphase )
		{
			SSVPanelBlock panelblock = new SSVPanelBlock{name = "O15", obj = new List<SSVscnObject>(), switch_pos = new List<Tuple<string,string>>()};

			switch (missionphase)
			{
				case MissionPhase.Preview:
					panelblock.switch_pos.Add( Tuple.Create( "BRAKES MN B", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "MDM OF 1/2 B", "OPEN" ) );
					panelblock.switch_pos.Add( Tuple.Create( "NOSE WHEEL STEERING MN B", "OPEN" ) );
					panelblock.switch_pos.Add( Tuple.Create( "STAR TRKR -Y", "OPEN" ) );
					panelblock.switch_pos.Add( Tuple.Create( "DDU LEFT MN B", "OPEN" ) );
					panelblock.switch_pos.Add( Tuple.Create( "DDU RIGHT MN B", "OPEN" ) );
					panelblock.switch_pos.Add( Tuple.Create( "RJDA 1B LOGIC", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "RJDA 1B DRIVER", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "RJDF 1A LOGIC", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "RJDF 1A DRIVER", "OFF" ) );
					break;
				case MissionPhase.LaunchT20m:
					break;
				case MissionPhase.LaunchT9m:
		...
		private void Panel_O16( MissionPhase missionphase )
		{
			SSVPanelBlock panelblock = new SSVPanelBlock{name = "O16", obj = new List<SSVscnObject>(), switch_pos = new List<Tuple<string,string>>()};

			switch (missionphase)
			{
				case MissionPhase.Preview:
					panelblock.switch_pos.Add( Tuple.Create( "BRAKES MN C", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "MDM OF 3/4 B", "OPEN" ) );
					panelblock.switch_pos.Add( Tuple.Create( "DDU RIGHT MN C", "OPEN" ) );
					panelblock.switch_pos.Add( Tuple.Create( "DDU AFT MN C", "OPEN" ) );
					panelblock.switch_pos.Add( Tuple.Create( "RJDA 2B LOGIC", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "RJDA 2B DRIVER", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "RJDF 2A LOGIC", "OFFN" ) );
					panelblock.switch_pos.Add( Tuple.Create( "RJDF 2A DRIVER", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "RJDF 2B LOGIC", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "RJDF 2B DRIVER", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "R OMS ENG VLV", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "RJD MANF DRIVER", "OFF" ) );
					break;
				case MissionPhase.LaunchT20m:
					break;
				case MissionPhase.LaunchT9m:
		...
		private void Panel_O17( MissionPhase missionphase )
		{
			SSVPanelBlock panelblock = new SSVPanelBlock{name = "O17", obj = new List<SSVscnObject>(), switch_pos = new List<Tuple<string,string>>()};

			switch (missionphase)
			{
				case MissionPhase.Preview:
					panelblock.switch_pos.Add( Tuple.Create( "ATVC 1", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "ATVC 2", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "ATVC 3", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "ATVC 4", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "EIU L-C", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "EIU C-R", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "EIU R-L", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "MDM OA1/2/3", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "MEC 1", "OFF" ) );
					panelblock.switch_pos.Add( Tuple.Create( "MEC 2", "OFF" ) );
					break;
				case MissionPhase.LaunchT20m:
					break;
				case MissionPhase.LaunchT9m:
		...
		private void Panel_L10( MissionPhase missionphase )
		{
			if (mission.LargeUpperStage == 1)
			{
				SSVPanelBlock panelblock = new SSVPanelBlock{name = "L10_IUS", obj = new List<SSVscnObject>(), switch_pos = new List<Tuple<string,string>>()};
		...
		private void Panel_L12( MissionPhase missionphase )
		{
			if (mission.LargeUpperStage == 1)
			{
				SSVPanelBlock panelblock = new SSVPanelBlock{name = "L12U_IUS", obj = new List<SSVscnObject>(), switch_pos = new List<Tuple<string,string>>()};
			...
			{
				SSVPanelBlock panelblock = new SSVPanelBlock{name = "L12U_Centaur", obj = new List<SSVscnObject>(), switch_pos = new List<Tuple<string,string>>()};
		...
		private void Panel_A1U( MissionPhase missionphase )
		{
			SSVPanelBlock panelblock = new SSVPanelBlock{name = "A1U", obj = new List<SSVscnObject>(), switch_pos = new List<Tuple<string,string>>()};
		...
		private void Panel_AFD( MissionPhase missionphase )
		{
			SSVPanelBlock panelblock = new SSVPanelBlock{name = "AftMDU", obj = new List<SSVscnObject>(), switch_pos = new List<Tuple<string,string>>()};
			SSVscnObject panelobject = new SSVscnObject{name = "AFD1", param_val = new List<Tuple<string,string>>()};
			panelobject.param_val.Add( Tuple.Create( "DISPLAY", "0" ) );
			panelobject.param_val.Add( Tuple.Create( "MENU", "3" ) );
			panelobject.param_val.Add( Tuple.Create( "PORT_CFG", "AUTO" ) );
			panelobject.param_val.Add( Tuple.Create( "PORT_SEL", "PRI" ) );
		...
		private void Panel_A2( MissionPhase missionphase )
		{
			SSVPanelBlock panelblock = new SSVPanelBlock{name = "A2", obj = new List<SSVscnObject>(), switch_pos = new List<Tuple<string,string>>()};
		...
		private void Panel_A3( MissionPhase missionphase )
		{
			SSVPanelBlock panelblock = new SSVPanelBlock{name = "A3", obj = new List<SSVscnObject>(), switch_pos = new List<Tuple<string,string>>()};
			SSVscnObject panelobject = new SSVscnObject{name = "MONITOR 1", param_val = new List<Tuple<string,string>>()};
		...
		private void Panel_A4( MissionPhase missionphase )
		{
			SSVPanelBlock panelblock = new SSVPanelBlock{name = "A4", obj = new List<SSVscnObject>(), switch_pos = new List<Tuple<string,string>>()};
		...
		private void Panel_A6U( MissionPhase missionphase )
		{
			SSVPanelBlock panelblock = new SSVPanelBlock{name = "A6U", obj = new List<SSVscnObject>(), switch_pos = new List<Tuple<string,string>>()};
		...
		private void Panel_A6L( MissionPhase missionphase )
		{
			if (mission.OV.ODS)
			{
				SSVPanelBlock panelblock = new SSVPanelBlock{name = "A6L", obj = new List<SSVscnObject>(), switch_pos = new List<Tuple<string,string>>()};
		...
		private void Panel_A7U( MissionPhase missionphase )
		{
			SSVPanelBlock panelblock = new SSVPanelBlock{name = "A7U", obj = new List<SSVscnObject>(), switch_pos = new List<Tuple<string,string>>()};
		...
		private void Panel_A7L( MissionPhase missionphase )
		{
			if (mission.OV.ODS)
			{
				SSVPanelBlock panelblock = new SSVPanelBlock{name = "A7L", obj = new List<SSVscnObject>(), switch_pos = new List<Tuple<string,string>>()};
			...
			{
				SSVPanelBlock panelblock = new SSVPanelBlock{name = "A7A3_SPDS", obj = new List<SSVscnObject>(), switch_pos = new List<Tuple<string,string>>()};
		...
		private void Panel_A8U( MissionPhase missionphase )
		{
			if ((mission.OV.PortLongeronSill == LongeronSillHardware_Type.RMS) || (mission.OV.StbdLongeronSill == LongeronSillHardware_Type.RMS))
			{
				SSVPanelBlock panelblock = new SSVPanelBlock{name = "A8A1", obj = new List<SSVscnObject>(), switch_pos = new List<Tuple<string,string>>()};
		...
		private void Panel_A8L( MissionPhase missionphase )
		{
			if ((mission.OV.PortLongeronSill != LongeronSillHardware_Type.None) || (mission.OV.StbdLongeronSill != LongeronSillHardware_Type.None))
			{
				SSVPanelBlock panelblock = new SSVPanelBlock{name = "A8A2", obj = new List<SSVscnObject>(), switch_pos = new List<Tuple<string,string>>()};
		...
		private void Panel_R11U( MissionPhase missionphase )
		{
			SSVPanelBlock panelblock = new SSVPanelBlock{name = "R11U", obj = new List<SSVscnObject>(), switch_pos = new List<Tuple<string,string>>()};
			SSVscnObject panelobject = new SSVscnObject{name = "CRT4", param_val = new List<Tuple<string,string>>()};
			panelobject.param_val.Add( Tuple.Create( "DISPLAY", "0" ) );
			panelobject.param_val.Add( Tuple.Create( "MENU", "3" ) );
			panelobject.param_val.Add( Tuple.Create( "PORT_CFG", "AUTO" ) );
			panelobject.param_val.Add( Tuple.Create( "PORT_SEL", "PRI" ) );
		...
		private void Panel_R11L( MissionPhase missionphase )
		{
			SSVPanelBlock panelblock = new SSVPanelBlock{name = "R11L", obj = new List<SSVscnObject>(), switch_pos = new List<Tuple<string,string>>()};

			switch (missionphase)
			{
				case MissionPhase.Preview:
					panelblock.switch_pos.Add( Tuple.Create( "IDP/CRT 4 POWER", "OFF" ) );
		...
		private void Panel_R13U( MissionPhase missionphase )
		{
			SSVPanelBlock panelblock = new SSVPanelBlock{name = "R13U", obj = new List<SSVscnObject>(), switch_pos = new List<Tuple<string,string>>()};
		...
		private void Panel_R13L( MissionPhase missionphase )
		{
			SSVPanelBlock panelblock = new SSVPanelBlock{name = "R13L", obj = new List<SSVscnObject>(), switch_pos = new List<Tuple<string,string>>()};
		...
		private void Panel_R14( MissionPhase missionphase )
		{
			SSVPanelBlock panelblock = new SSVPanelBlock{name = "R14", obj = new List<SSVscnObject>(), switch_pos = new List<Tuple<string,string>>()};
