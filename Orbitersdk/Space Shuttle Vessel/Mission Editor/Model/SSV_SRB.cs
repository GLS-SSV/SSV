...
namespace SSVMissionEditor.model
{
	...
	{
		public SSV_SRB( Mission mission, bool left )
		{
			attached.Clear();
			if (left)
			{
				_class = "SSV_SRB_LH";
				name = "LSRB";
				attached.Add( Tuple.Create( 0, 28, mission.OV.Name.ToString() ) );
			}
			else
			{
				_class = "SSV_SRB_RH";
				name = "RSRB";
				attached.Add( Tuple.Create( 0, 29, mission.OV.Name.ToString() ) );
			}
