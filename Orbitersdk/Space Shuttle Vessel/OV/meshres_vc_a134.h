...
inline constexpr unsigned int GRP_PANEL_A134_VC	=	0;	//panel
inline constexpr unsigned int GRP_MDUFRAME_A134_VC	=	1;	//mduframe
inline constexpr unsigned int GRP_AFD1_A134_VC	=	2;	//AFD1
