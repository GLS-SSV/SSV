/****************************************************************************
  ...
  Simple Multiplexer/Demultiplexer Flight-Critical Aft 2 definition
...
/****************************************************************************
  ...
  **************************************************************************/
#ifndef _SIMPLEMDM_FA2_H_
#define _SIMPLEMDM_FA2_H_
...
namespace dps
{
	class SimpleMDM_FA2:public SimpleMDM
	{
		private:
			bool powered;
		...
		public:
			SimpleMDM_FA2( AtlantisSubsystemDirector* _director, BusManager* pBusManager );
			virtual ~SimpleMDM_FA2();
