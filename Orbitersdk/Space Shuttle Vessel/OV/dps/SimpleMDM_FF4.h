/****************************************************************************
  ...
  Simple Multiplexer/Demultiplexer Flight-Critical Forward 4 definition
...
/****************************************************************************
  ...
  **************************************************************************/
#ifndef _SIMPLEMDM_FF4_H_
#define _SIMPLEMDM_FF4_H_
...
namespace dps
{
	class SimpleMDM_FF4:public SimpleMDM
	{
		private:
			bool powered;
		...
		public:
			SimpleMDM_FF4( AtlantisSubsystemDirector* _director, BusManager* pBusManager );
			virtual ~SimpleMDM_FF4();
