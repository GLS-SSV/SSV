...
namespace dps
{
	SimpleMDM_FF1::SimpleMDM_FF1( AtlantisSubsystemDirector* _director, BusManager* pBusManager ):SimpleMDM( _director, "SimpleMDM_FF1", pBusManager ),
		powered(true)
	{
		BusConnect( BUS_FC1 );
		BusConnect( BUS_FC5 );
	...
	void SimpleMDM_FF1::Rx( const BUS_ID id, void* data, const unsigned short datalen )
	{
