...
inline constexpr unsigned int SCP_FA1_IOM11_CH0_DATA = 0x00464;// INTEGER SINGLE

// MDM FA2 input
// 13-R AFT VENTS 8 & 9 CLOSED 2
// 14-R AFT VENTS 8 & 9 OPEN 2
// 15-R AFT VENTS 8 & 9 PURGE IND 2
inline constexpr unsigned int SCP_FA2_IOM11_CH0_DATA = 0x00465;// INTEGER SINGLE

// MDM FA3 input
// 13-R AFT VENTS 8 & 9 CLOSED 1
// 14-R AFT VENTS 8 & 9 OPEN 1
// 15-R AFT VENTS 8 & 9 PURGE IND 1
inline constexpr unsigned int SCP_FA3_IOM11_CH0_DATA = 0x00466;// INTEGER SINGLE

// MDM FA4 input
// 13-L AFT VENTS 8 & 9 CLOSED 2
// 14-L AFT VENTS 8 & 9 OPEN 2
// 15-L AFT VENTS 8 & 9 PURGE IND 2
inline constexpr unsigned int SCP_FA4_IOM11_CH0_DATA = 0x00467;// INTEGER SINGLE
...
inline constexpr unsigned int SCP_FF1_IOM2_CH0_DATA = 0x00468;// INTEGER SINGLE
...
inline constexpr unsigned int SCP_FF1_IOM2_CH1_DATA = 0x00469;// INTEGER SINGLE
...
inline constexpr unsigned int SCP_FF1_IOM2_CH2_DATA = 0x0046a;// INTEGER SINGLE
// 0-FWD EVENT TIMER: ABORT TIMER_RESET
// 11-C&W MATRIX "LEFT RCS" (LEAK DETECT)
inline constexpr unsigned int SCP_FF1_IOM5_CH1_DATA = 0x0046b;// INTEGER SINGLE
...
inline constexpr unsigned int SCP_FF1_IOM10_CH0_DATA = 0x0046c;// INTEGER SINGLE
...
inline constexpr unsigned int SCP_FF1_IOM10_CH1_DATA = 0x0046d;// INTEGER SINGLE
...
inline constexpr unsigned int SCP_FF1_IOM10_CH2_DATA = 0x0046e;// INTEGER SINGLE

// MDM FF2 output
// 0-LH VENTS 1/2 MOTOR 2/CLOSE B (CL/2B)
// 1-LH VENTS 1/2 MOTOR 2/OPEN B (OP/2B)
// 2-LH VENTS 1/2 MOTOR 2/PURGE B (PG/2B)
inline constexpr unsigned int SCP_FF2_IOM2_CH0_DATA = 0x0046f;// INTEGER SINGLE
// 0-F7 LIGHT: L MPS AMBER STATUS
// 6-RH VENT 5 MOTOR 2/CLOSE B (CL/2B)
inline constexpr unsigned int SCP_FF2_IOM2_CH1_DATA = 0x00470;// INTEGER SINGLE
...
inline constexpr unsigned int SCP_FF2_IOM2_CH2_DATA = 0x00471;// INTEGER SINGLE
...
inline constexpr unsigned int SCP_FF2_IOM10_CH0_DATA = 0x00472;// INTEGER SINGLE
// 0-F7 LIGHT: L MPS RED STATUS
inline constexpr unsigned int SCP_FF2_IOM10_CH1_DATA = 0x00473;// INTEGER SINGLE
// 3-C&W MATRIX "BACKUP C/W ALARM"
...
inline constexpr unsigned int SCP_FF2_IOM10_CH2_DATA = 0x00474;// INTEGER SINGLE

// MDM FF3 output
// 0-LH VENT 3 MOTOR 1/OPEN B (OP/1B)
// 1-LH VENTS 1/2 MOTOR 1/OPEN B (OP/1B)
// 2-LH VENTS 1/2 MOTOR 1/PURGE B (PG/1B)
inline constexpr unsigned int SCP_FF3_IOM2_CH0_DATA = 0x00475;// INTEGER SINGLE
...
inline constexpr unsigned int SCP_FF3_IOM2_CH1_DATA = 0x00476;// INTEGER SINGLE
...
inline constexpr unsigned int SCP_FF3_IOM2_CH2_DATA = 0x00477;// INTEGER SINGLE
...
inline constexpr unsigned int SCP_FF3_IOM5_CH1_DATA = 0x00478;// INTEGER SINGLE
...
inline constexpr unsigned int SCP_FF3_IOM10_CH0_DATA = 0x00479;// INTEGER SINGLE
...
inline constexpr unsigned int SCP_FF3_IOM10_CH1_DATA = 0x0047a;// INTEGER SINGLE
...
inline constexpr unsigned int SCP_FF3_IOM10_CH2_DATA = 0x0047b;// INTEGER SINGLE

// MDM FF4 output
// 0-RH VENT 3 MOTOR 2/OPEN B (OP/2B)
// 1-RH VENTS 1/2 MOTOR 2/OPEN B (OP/2B)
// 2-RH VENTS 1/2 MOTOR 2/PURGE B (PG/2B)
inline constexpr unsigned int SCP_FF4_IOM2_CH0_DATA = 0x0047c;// INTEGER SINGLE
// 6-LH VENT 5 MOTOR 2/CLOSE B (CL/2B)
inline constexpr unsigned int SCP_FF4_IOM2_CH1_DATA = 0x0047d;// INTEGER SINGLE
...
inline constexpr unsigned int SCP_FF4_IOM2_CH2_DATA = 0x0047e;// INTEGER SINGLE
// 0-FWD EVENT TIMER: LIFT OFF TIMER_RESET
inline constexpr unsigned int SCP_FF4_IOM5_CH1_DATA = 0x0047f;// INTEGER SINGLE
...
inline constexpr unsigned int SCP_FF4_IOM10_CH0_DATA = 0x00480;// INTEGER SINGLE
// 3-C&W MATRIX "BACKUP C/W ALARM"
...
inline constexpr unsigned int SCP_FF4_IOM10_CH2_DATA = 0x00481;// INTEGER SINGLE

// MDM FA1 output
// 4-LH VENTS 8/9 MOTOR 1/CLOSE A (CL/1A)
// 5-LH VENTS 8/9 MOTOR 1/OPEN A (OP/1A)
// 6-LH VENTS 8/9 MOTOR 1/PURGE A (PG/1A)
inline constexpr unsigned int SCP_FA1_IOM7_CH0_DATA = 0x00482;// INTEGER SINGLE
// 3-LH VENTS 8/9 MOTOR 1/CLOSE B (CL/1B)
// 4-LH VENTS 8/9 MOTOR 1/OPEN B (OP/1B)
// 5-LH VENTS 8/9 MOTOR 1/PURGE B (PG/1B)
inline constexpr unsigned int SCP_FA1_IOM15_CH0_DATA = 0x00483;// INTEGER SINGLE

// MDM FA2 output
// 4-RH VENTS 8/9 MOTOR 2/CLOSE A (CL/2A)
// 5-RH VENTS 8/9 MOTOR 2/OPEN A (OP/2A)
// 6-RH VENTS 8/9 MOTOR 2/PURGE A (PG/2A)
inline constexpr unsigned int SCP_FA2_IOM7_CH0_DATA = 0x00484;// INTEGER SINGLE
// 3-RH VENTS 8/9 MOTOR 2/CLOSE B (CL/2B)
// 4-RH VENTS 8/9 MOTOR 2/OPEN B (OP/2B)
// 5-RH VENTS 8/9 MOTOR 2/PURGE B (PG/2B)
inline constexpr unsigned int SCP_FA2_IOM15_CH0_DATA = 0x00485;// INTEGER SINGLE

// MDM FA3 output
// 4-RH VENTS 8/9 MOTOR 1/CLOSE A (CL/1A)
// 5-RH VENTS 8/9 MOTOR 1/OPEN A (OP/1A)
// 6-RH VENTS 8/9 MOTOR 1/PURGE A (PG/1A)
inline constexpr unsigned int SCP_FA3_IOM7_CH0_DATA = 0x00486;// INTEGER SINGLE
// 3-RH VENTS 8/9 MOTOR 1/CLOSE B (CL/1B)
// 4-RH VENTS 8/9 MOTOR 1/OPEN B (OP/1B)
// 5-RH VENTS 8/9 MOTOR 1/PURGE B (PG/1B)
inline constexpr unsigned int SCP_FA3_IOM15_CH0_DATA = 0x00487;// INTEGER SINGLE

// MDM FA4 output
// 4-LH VENTS 8/9 MOTOR 2/CLOSE A (CL/2A)
// 5-LH VENTS 8/9 MOTOR 2/OPEN A (OP/2A)
// 6-LH VENTS 8/9 MOTOR 2/PURGE A (PG/2A)
inline constexpr unsigned int SCP_FA4_IOM7_CH0_DATA = 0x00488;// INTEGER SINGLE
// 3-LH VENTS 8/9 MOTOR 2/CLOSE B (CL/2B)
// 4-LH VENTS 8/9 MOTOR 2/OPEN B (OP/2B)
// 5-LH VENTS 8/9 MOTOR 2/PURGE B (PG/2B)
inline constexpr unsigned int SCP_FA4_IOM15_CH0_DATA = 0x00489;// INTEGER SINGLE

// MDM PF1 output
// 12-C&W MATRIX "BACKUP C/W ALARM"
// 13-SM ALERT: TONE B CMD 1
// 14-SM ALERT: LIGHT B CMD 1
inline constexpr unsigned int SCP_PF1_IOM2_CH0_DATA = 0x0048a;// INTEGER SINGLE

// MDM PF2 output
// 12-C&W MATRIX "BACKUP C/W ALARM"
// 13-SM ALERT: TONE B CMD 2
// 14-SM ALERT: LIGHT B CMD 2
inline constexpr unsigned int SCP_PF2_IOM2_CH0_DATA = 0x0048b;// INTEGER SINGLE
// 2-C&W MATRIX "PAYLOAD WARNING"
inline constexpr unsigned int SCP_PF2_IOM10_CH2_DATA = 0x0048c;// INTEGER SINGLE

// Radar Altimeter
inline constexpr unsigned int SCP_RA_DATA_CDR_SEL = 0x0048d;// INTEGER SINGLE
inline constexpr unsigned int SCP_RA_VALIDITY_CDR_SEL = 0x0048e;// INTEGER SINGLE
inline constexpr unsigned int SCP_RA_DATA_PLT_SEL = 0x0048f;// INTEGER SINGLE
inline constexpr unsigned int SCP_RA_VALIDITY_PLT_SEL = 0x00490;// INTEGER SINGLE

// DAP PBIs light command
// forward
inline constexpr unsigned int SCP_FWD_DAP_SELECT_A_LT = 0x00491;// INTEGER SINGLE
inline constexpr unsigned int SCP_FWD_DAP_SELECT_B_LT = 0x00492;// INTEGER SINGLE
inline constexpr unsigned int SCP_FWD_DAP_AUTO_LT = 0x00493;// INTEGER SINGLE
inline constexpr unsigned int SCP_FWD_DAP_MAN_INRTL_LT = 0x00494;// INTEGER SINGLE
inline constexpr unsigned int SCP_FWD_DAP_MAN_LVLH_LT = 0x00495;// INTEGER SINGLE
inline constexpr unsigned int SCP_FWD_DAP_MAN_FREE_DFT_LT = 0x00496;// INTEGER SINGLE
inline constexpr unsigned int SCP_FWD_BLANK_LT = 0x00497;// INTEGER SINGLE
inline constexpr unsigned int SCP_FWD_TRANSL_X_NORM_LT = 0x00498;// INTEGER SINGLE
inline constexpr unsigned int SCP_FWD_TRANSL_X_PULSE_LT = 0x00499;// INTEGER SINGLE
inline constexpr unsigned int SCP_FWD_TRANSL_LOW_Z_LT = 0x0049a;// INTEGER SINGLE
inline constexpr unsigned int SCP_FWD_TRANSL_Y_NORM_LT = 0x0049b;// INTEGER SINGLE
inline constexpr unsigned int SCP_FWD_TRANSL_Y_PULSE_LT = 0x0049c;// INTEGER SINGLE
inline constexpr unsigned int SCP_FWD_TRANSL_Z_HIGH_LT = 0x0049d;// INTEGER SINGLE
inline constexpr unsigned int SCP_FWD_TRANSL_Z_NORM_LT = 0x0049e;// INTEGER SINGLE
inline constexpr unsigned int SCP_FWD_TRANSL_Z_PULSE_LT = 0x0049f;// INTEGER SINGLE
inline constexpr unsigned int SCP_FWD_RCS_JETS_NORM_LT = 0x004a0;// INTEGER SINGLE
inline constexpr unsigned int SCP_FWD_ROT_ROLL_DISC_LT = 0x004a1;// INTEGER SINGLE
inline constexpr unsigned int SCP_FWD_ROT_ROLL_PULSE_LT = 0x004a2;// INTEGER SINGLE
inline constexpr unsigned int SCP_FWD_ALT_PRCS_MODE_LT = 0x004a3;// INTEGER SINGLE
inline constexpr unsigned int SCP_FWD_ROT_PITCH_DISC_LT = 0x004a4;// INTEGER SINGLE
inline constexpr unsigned int SCP_FWD_ROT_PITCH_PULSE_LT = 0x004a5;// INTEGER SINGLE
inline constexpr unsigned int SCP_FWD_RCS_JETS_VERN_LT = 0x004a6;// INTEGER SINGLE
inline constexpr unsigned int SCP_FWD_ROT_YAW_DISC_LT = 0x004a7;// INTEGER SINGLE
inline constexpr unsigned int SCP_FWD_ROT_YAW_PULSE_LT = 0x004a8;// INTEGER SINGLE
// aft
inline constexpr unsigned int SCP_AFT_DAP_SELECT_A_LT = 0x004a9;// INTEGER SINGLE
inline constexpr unsigned int SCP_AFT_DAP_SELECT_B_LT = 0x004aa;// INTEGER SINGLE
inline constexpr unsigned int SCP_AFT_DAP_AUTO_LT = 0x004ab;// INTEGER SINGLE
inline constexpr unsigned int SCP_AFT_DAP_MAN_INRTL_LT = 0x004ac;// INTEGER SINGLE
inline constexpr unsigned int SCP_AFT_DAP_MAN_LVLH_LT = 0x004ad;// INTEGER SINGLE
inline constexpr unsigned int SCP_AFT_DAP_MAN_FREE_DFT_LT = 0x004ae;// INTEGER SINGLE
inline constexpr unsigned int SCP_AFT_BLANK_LT = 0x004af;// INTEGER SINGLE
inline constexpr unsigned int SCP_AFT_TRANSL_X_NORM_LT = 0x004b0;// INTEGER SINGLE
inline constexpr unsigned int SCP_AFT_TRANSL_X_PULSE_LT = 0x004b1;// INTEGER SINGLE
inline constexpr unsigned int SCP_AFT_TRANSL_LOW_Z_LT = 0x004b2;// INTEGER SINGLE
inline constexpr unsigned int SCP_AFT_TRANSL_Y_NORM_LT = 0x004b3;// INTEGER SINGLE
inline constexpr unsigned int SCP_AFT_TRANSL_Y_PULSE_LT = 0x004b4;// INTEGER SINGLE
inline constexpr unsigned int SCP_AFT_TRANSL_Z_HIGH_LT = 0x004b5;// INTEGER SINGLE
inline constexpr unsigned int SCP_AFT_TRANSL_Z_NORM_LT = 0x004b6;// INTEGER SINGLE
inline constexpr unsigned int SCP_AFT_TRANSL_Z_PULSE_LT = 0x004b7;// INTEGER SINGLE
inline constexpr unsigned int SCP_AFT_RCS_JETS_NORM_LT = 0x004b8;// INTEGER SINGLE
inline constexpr unsigned int SCP_AFT_ROT_ROLL_DISC_LT = 0x004b9;// INTEGER SINGLE
inline constexpr unsigned int SCP_AFT_ROT_ROLL_PULSE_LT = 0x004ba;// INTEGER SINGLE
inline constexpr unsigned int SCP_AFT_ALT_PRCS_MODE_LT = 0x004bb;// INTEGER SINGLE
inline constexpr unsigned int SCP_AFT_ROT_PITCH_DISC_LT = 0x004bc;// INTEGER SINGLE
inline constexpr unsigned int SCP_AFT_ROT_PITCH_PULSE_LT = 0x004bd;// INTEGER SINGLE
inline constexpr unsigned int SCP_AFT_RCS_JETS_VERN_LT = 0x004be;// INTEGER SINGLE
inline constexpr unsigned int SCP_AFT_ROT_YAW_DISC_LT = 0x004bf;// INTEGER SINGLE
inline constexpr unsigned int SCP_AFT_ROT_YAW_PULSE_LT = 0x004c0;// INTEGER SINGLE

// TAEM parameters
// maximum shuttle orbiter weight [slugs]
inline constexpr unsigned int SCP_WT_GS1 = 0x004c1;// SCALAR DOUBLE
// minimum RPRED to issue OHALRT [ft]
inline constexpr unsigned int SCP_RMOH = 0x004c3;// SCALAR DOUBLE
// HAC turn angle [deg]
inline constexpr unsigned int SCP_PSHA = 0x004c5;// SCALAR DOUBLE
// HAC radius [ft]
inline constexpr unsigned int SCP_RTURN = 0x004c7;// SCALAR DOUBLE
// R/L cone indicator [1]
inline constexpr unsigned int SCP_YSGN = 0x004c9;// SCALAR DOUBLE
// PSHA reset value [deg]
inline constexpr unsigned int SCP_PSHARS = 0x004cb;// SCALAR DOUBLE
// initial HAC spiral turn radius on final [ft]
inline constexpr unsigned int SCP_RF0 = 0x004cd;// SCALAR DOUBLE
// linear term in spiral radius eqn. [ft/deg]
inline constexpr unsigned int SCP_R1 = 0x004cf;// SCALAR DOUBLE
// quadratic term in spiral radius eqn. [ft/deg]
inline constexpr unsigned int SCP_R2 = 0x004d1;// SCALAR DOUBLE

// Autoland parameters
// pullup circle radius (indexed by IGI,IGS) [ft]
inline constexpr unsigned int SCP_AL_R = 0x004d3;// MATRIX(2,2) DOUBLE
// pullup circle center (x) (indexed by IGI,IGS) [ft]
inline constexpr unsigned int SCP_X_K = 0x004db;// MATRIX(2,2) DOUBLE
// pullup circle center (h) (indexed by IGI,IGS) [ft]
inline constexpr unsigned int SCP_H_K = 0x004e3;// MATRIX(2,2) DOUBLE
// exponential/circle tangency range (indexed by IGI,IGS) [ft]
inline constexpr unsigned int SCP_X_EXP = 0x004eb;// MATRIX(2,2) DOUBLE
// exponential decay (indexed by IGI,IGS) [ft]
inline constexpr unsigned int SCP_H_DECAY = 0x004f3;// MATRIX(2,2) DOUBLE
// exponential decay factor [1]
inline constexpr unsigned int SCP_SIGMA = 0x004fb;// SCALAR DOUBLE
// steep glideslop angle (indexed by IGS) [deg]
inline constexpr unsigned int SCP_GAMMA_REF_1 = 0x004fd;// VECTOR(2) DOUBLE
// shallow glideslop angle [deg]
inline constexpr unsigned int SCP_GAMMA_REF_2 = 0x00501;// SCALAR DOUBLE
// steep glide slope aim point (indexed by IGI) [ft]
inline constexpr unsigned int SCP_X_ZERO = 0x00503;// VECTOR(2) DOUBLE
// shallow glide slope aim point [ft]
inline constexpr unsigned int SCP_X_AIM = 0x00507;// SCALAR DOUBLE
// open-loop pull-up altitude [ft]
inline constexpr unsigned int SCP_H_FLARE = 0x00509;// SCALAR DOUBLE
// closed-loop pull-up altitude [ft]
inline constexpr unsigned int SCP_H_CLOOP = 0x0050b;// SCALAR DOUBLE

// runway approach mode (1-overhead; 2-strait-in)
inline constexpr unsigned int SCP_OVHD = 0x0050d;// INTEGER SINGLE
// glide slope (1-light; 2-heavy)
inline constexpr unsigned int SCP_IGS = 0x0050e;// INTEGER SINGLE
// aimpoint (1-nom; 2-close-in)
inline constexpr unsigned int SCP_IGI = 0x0050f;// INTEGER SINGLE
// runway ID (1-pri; 2-sec)
inline constexpr unsigned int SCP_RWID = 0x00510;// INTEGER SINGLE
// previous runway ID (1-pri; 2-sec)
inline constexpr unsigned int SCP_RWID0 = 0x00511;// INTEGER SINGLE
// landing site ID [1,45]
inline constexpr unsigned int SCP_LSID = 0x00512;// INTEGER SINGLE

// speedbrake logic select (1-nom; 2-short; 3-ELS)
inline constexpr unsigned int SCP_SB_SEL = 0x00513;// INTEGER SINGLE

// pri runway name
inline constexpr unsigned int SCP_PRI_ID = 0x00514;// CHARACTER(5)
// pri runway heading [deg]
inline constexpr unsigned int SCP_PRI_HDG = 0x00519;// SCALAR DOUBLE
// pri runway pos (greenwich=ECEF) [ft]
inline constexpr unsigned int SCP_PRI_POS = 0x0051b;// VECTOR(3) DOUBLE
// pri greenwich(=ECEF)-to-runway matrix [ft]
inline constexpr unsigned int SCP_PRI_G2R = 0x00521;// MATRIX(3,3) DOUBLE
// pri runway length [ft]
inline constexpr unsigned int SCP_PRI_LEN = 0x00533;// INTEGER SINGLE
// sec runway name
inline constexpr unsigned int SCP_SEC_ID = 0x00534;// CHARACTER(5)
// sec runway heading [deg]
inline constexpr unsigned int SCP_SEC_HDG = 0x00539;// SCALAR DOUBLE
// sec runway pos (greenwich=ECEF) [ft]
inline constexpr unsigned int SCP_SEC_POS = 0x0053b;// VECTOR(3) DOUBLE
// sec greenwich(=ECEF)-to-runway matrix [ft]
inline constexpr unsigned int SCP_SEC_G2R = 0x00541;// MATRIX(3,3) DOUBLE
// sec runway length [ft]
inline constexpr unsigned int SCP_SEC_LEN = 0x00553;// INTEGER SINGLE

// Landing SOP
inline constexpr unsigned int SCP_WOWLON = 0x00554;// INTEGER SINGLE
inline constexpr unsigned int SCP_FLATTURN = 0x00555;// INTEGER SINGLE
inline constexpr unsigned int SCP_ROLLOUT = 0x00556;// INTEGER SINGLE
inline constexpr unsigned int SCP_GSENBL = 0x00557;// INTEGER SINGLE
inline constexpr unsigned int SCP_HUD_WOWLON = 0x00558;// INTEGER SINGLE
inline constexpr unsigned int SCP_HUD_ROLLOUT = 0x00559;// INTEGER SINGLE

// Aerojet DAP FCS
// AerojetDAP FCS pitch control (1-AUTO; 2-CSS)
inline constexpr unsigned int SCP_AEROJET_FCS_PITCH = 0x0055a;// INTEGER SINGLE
// AerojetDAP FCS roll control (1-AUTO; 2-CSS)
inline constexpr unsigned int SCP_AEROJET_FCS_ROLL = 0x0055b;// INTEGER SINGLE
// AerojetDAP FCS speedbrake control (1-AUTO; 2-CDR; 3-PLT)
inline constexpr unsigned int SCP_AEROJET_FCS_SB = 0x0055c;// INTEGER SINGLE
// AerojetDAP body flap control (1-AUTO; 2-CSS)
inline constexpr unsigned int SCP_AEROJET_FCS_BF = 0x0055d;// INTEGER SINGLE
// number of RCS roll jets to fire (+right, -left) [1]
inline constexpr unsigned int SCP_UXCMD = 0x0055e;// INTEGER SINGLE
// number of RCS pitch jets to fire (+up, -down) [1]
inline constexpr unsigned int SCP_UYCMD = 0x0055f;// INTEGER SINGLE
// number of RCS yaw jets to fire (+right, -left) [1]
inline constexpr unsigned int SCP_UZCMD = 0x00560;// INTEGER SINGLE
// aileron trim [deg]
inline constexpr unsigned int SCP_DATRIM = 0x00561;// SCALAR DOUBLE
// rudder trim [deg]
inline constexpr unsigned int SCP_DRTRIM = 0x00563;// SCALAR DOUBLE
// NY trim [g]
inline constexpr unsigned int SCP_DRTI = 0x00565;// SCALAR DOUBLE
// NZ error [g]
inline constexpr unsigned int SCP_NZERR = 0x00567;// SCALAR DOUBLE
// bank error [deg]
inline constexpr unsigned int SCP_BANKERR = 0x00569;// SCALAR DOUBLE
// wraparound DAP mode (0=INH, 1=ENA, 2=ACT)
inline constexpr unsigned int SCP_WRAP = 0x0056b;// INTEGER SINGLE
// elevator command [deg]
inline constexpr unsigned int SCP_DECC = 0x0056c;// SCALAR DOUBLE
// aileron command [deg]
inline constexpr unsigned int SCP_DAC = 0x0056e;// SCALAR DOUBLE
// rudder command [deg]
inline constexpr unsigned int SCP_DRC = 0x00570;// SCALAR DOUBLE
// speedbrake command [deg]
inline constexpr unsigned int SCP_DSBC = 0x00572;// SCALAR DOUBLE
// NWS command [deg]
inline constexpr unsigned int SCP_DNWC = 0x00574;// SCALAR DOUBLE
// Entry Mode switch "Low Gain" selected
inline constexpr unsigned int SCP_SEL_L_GAIN = 0x00576;// INTEGER SINGLE
// Entry Mode switch "No Yaw Jet" selected
inline constexpr unsigned int SCP_SEL_NO_Y_JET = 0x00577;// INTEGER SINGLE
// Entry Mode switch override
inline constexpr unsigned int SCP_ENTRY_SW_OVERRIDE = 0x00578;// INTEGER SINGLE

// A/L UPP
// geodetic altitude of vehicle center of mass above rw [ft]
inline constexpr unsigned int SCP_H = 0x00579;// SCALAR DOUBLE
// negative z component of velocity in topodetic coordinates [fps]
inline constexpr unsigned int SCP_HDOT = 0x0057b;// SCALAR DOUBLE
// true airspeed [fps]
inline constexpr unsigned int SCP_V_T = 0x0057d;// SCALAR DOUBLE
// equivalent? airspeed [fps]
inline constexpr unsigned int SCP_V_I = 0x0057f;// SCALAR DOUBLE
// equivalent airspeed [knots]
inline constexpr unsigned int SCP_KEAS = 0x00581;// SCALAR DOUBLE
// topodetic horizontal component of earth relative velocity [fps]
inline constexpr unsigned int SCP_VG = 0x00583;// SCALAR DOUBLE
// vehicle position in runway coordinates [ft]
inline constexpr unsigned int SCP_X = 0x00585;// SCALAR DOUBLE
inline constexpr unsigned int SCP_Y = 0x00587;// SCALAR DOUBLE
inline constexpr unsigned int SCP_Z = 0x00589;// SCALAR DOUBLE
// vehicle velocity in runway coordinates [fps]
inline constexpr unsigned int SCP_XDOT = 0x0058b;// SCALAR DOUBLE
inline constexpr unsigned int SCP_YDOT = 0x0058d;// SCALAR DOUBLE
// heading [deg]
inline constexpr unsigned int SCP_HDG = 0x0058f;// SCALAR DOUBLE
// topodetic earth relative flight-path angle [deg]
inline constexpr unsigned int SCP_GAMMA = 0x00591;// SCALAR DOUBLE
// roll [deg]
inline constexpr unsigned int SCP_PHI = 0x00593;// SCALAR DOUBLE
// cosine of body roll euler angle [1]
inline constexpr unsigned int SCP_COSPHI = 0x00595;// SCALAR DOUBLE
// sine of body roll euler angle [1]
inline constexpr unsigned int SCP_SINPHI = 0x00597;// SCALAR DOUBLE
// tangent of body roll euler angle [1]
inline constexpr unsigned int SCP_TANPHI = 0x00599;// SCALAR DOUBLE
// cosine of angle of attack [1]
inline constexpr unsigned int SCP_COSALF = 0x0059b;// SCALAR DOUBLE
// sine of angle of attack [1]
inline constexpr unsigned int SCP_SINALF = 0x0059d;// SCALAR DOUBLE
// pitch [deg]
inline constexpr unsigned int SCP_THETA = 0x0059f;// SCALAR DOUBLE
// cosine of theta [1]
inline constexpr unsigned int SCP_COSTH = 0x005a1;// SCALAR DOUBLE
// sine of theta [1]
inline constexpr unsigned int SCP_SINTH = 0x005a3;// SCALAR DOUBLE
// angle-of-attack [deg]
inline constexpr unsigned int SCP_ALPHA = 0x005a5;// SCALAR DOUBLE
// sideslip [deg]
inline constexpr unsigned int SCP_BETA = 0x005a7;// SCALAR DOUBLE
// dynamic pressure [psf]
inline constexpr unsigned int SCP_QBAR = 0x005a9;// SCALAR DOUBLE
// lateral acceleration [g]
inline constexpr unsigned int SCP_NY = 0x005ab;// SCALAR DOUBLE
// normal acceleration [g]
inline constexpr unsigned int SCP_NZ = 0x005ad;// SCALAR DOUBLE
// orbiter mass [slugs]
inline constexpr unsigned int SCP_WEIGHT = 0x005af;// SCALAR DOUBLE
// body roll rate [deg/s]
inline constexpr unsigned int SCP_P = 0x005b1;// SCALAR DOUBLE
// body pitch rate [deg/s]
inline constexpr unsigned int SCP_Q = 0x005b3;// SCALAR DOUBLE
// body yaw rate [deg/s]
inline constexpr unsigned int SCP_R = 0x005b5;// SCALAR DOUBLE

// TAEM UPP
// mach number [1]
inline constexpr unsigned int SCP_MACH = 0x005b7;// SCALAR DOUBLE
// course with respect to centerline [deg]
inline constexpr unsigned int SCP_PSD = 0x005b9;// SCALAR DOUBLE

// Entry UPP
// vehicle position in ECEF [ft]
inline constexpr unsigned int SCP_ECEF_POS = 0x005bb;// VECTOR(3) DOUBLE
// vehicle velocity in ECEF [fps]
inline constexpr unsigned int SCP_ECEF_VEL = 0x005c1;// VECTOR(3) DOUBLE
// current relative velocity [fps]
inline constexpr unsigned int SCP_VE = 0x005c7;// SCALAR DOUBLE
// current inertial velocity [fps]
inline constexpr unsigned int SCP_VI = 0x005c9;// SCALAR DOUBLE
// current drag acceleration [fps^2]
inline constexpr unsigned int SCP_DRAG = 0x005cb;// SCALAR DOUBLE
// current lift/drag ratio [1]
inline constexpr unsigned int SCP_LOD = 0x005cd;// SCALAR DOUBLE
// current load factor [fps^2]
inline constexpr unsigned int SCP_XLFAC = 0x005cf;// SCALAR DOUBLE

// EGRT output
// azimuth error [rad]
inline constexpr unsigned int SCP_DELAZ = 0x005d1;// SCALAR DOUBLE
// range to target [NM]
inline constexpr unsigned int SCP_TRANG = 0x005d3;// SCALAR DOUBLE

// Autoland guidance output
// autoland phase counter
inline constexpr unsigned int SCP_PMODE = 0x005d5;// INTEGER SINGLE
// FSGS phase counter
inline constexpr unsigned int SCP_FMODE = 0x005d6;// INTEGER SINGLE
// autoland NZ command [g]
inline constexpr unsigned int SCP_NZ_CMD = 0x005d7;// SCALAR DOUBLE
// autoland roll angle command [deg]
inline constexpr unsigned int SCP_PHIC_AL = 0x005d9;// SCALAR DOUBLE
// autoland yaw rate command post WOWLON
inline constexpr unsigned int SCP_RC = 0x005db;// SCALAR DOUBLE
// autoland speedbrake command [deg]
inline constexpr unsigned int SCP_DSBC_AL = 0x005dd;// SCALAR DOUBLE
// body flap retract command
inline constexpr unsigned int SCP_RETRACT_BF = 0x005df;// INTEGER SINGLE
// altitude error [ft]
inline constexpr unsigned int SCP_HERR = 0x005e0;// SCALAR DOUBLE

// TAEM guidance output
// heading error to HAC tangency [deg]
inline constexpr unsigned int SCP_DPSAC = 0x005e2;// SCALAR DOUBLE
// predicted range to rw [ft]
inline constexpr unsigned int SCP_RPRED = 0x005e4;// SCALAR DOUBLE
// commanded body normal load factor increment from equilibrium [g]
inline constexpr unsigned int SCP_NZC = 0x005e6;// SCALAR DOUBLE
// speedbrake angle command (hinge line) [deg]
inline constexpr unsigned int SCP_DSBC_AT = 0x005e8;// SCALAR DOUBLE
// roll angle command
inline constexpr unsigned int SCP_PHIC_AT = 0x005ea;// SCALAR DOUBLE
// minimum entry point flag
inline constexpr unsigned int SCP_MEP = 0x005ec;// INTEGER SINGLE
// TAEM phase counter [1]
inline constexpr unsigned int SCP_IPHASE = 0x005ed;// INTEGER SINGLE
// TAEM end flag
inline constexpr unsigned int SCP_TG_END = 0x005ee;// INTEGER SINGLE
// current HAC final size [ft]
inline constexpr unsigned int SCP_RF = 0x005ef;// SCALAR DOUBLE
// HAC X position [ft]
inline constexpr unsigned int SCP_XHAC = 0x005f1;// SCALAR DOUBLE
// distance from OV to HAC center [ft]
inline constexpr unsigned int SCP_RCIR = 0x005f3;// SCALAR DOUBLE
// energy per unit weight [ft]
inline constexpr unsigned int SCP_EOW = 0x005f5;// SCALAR DOUBLE
// reference energy [ft]
inline constexpr unsigned int SCP_EN = 0x005f7;// SCALAR DOUBLE
// E/W to start S-turn [ft]
inline constexpr unsigned int SCP_ES = 0x005f9;// SCALAR DOUBLE
// E/W to switch to MEP [ft]
inline constexpr unsigned int SCP_EMEP = 0x005fb;// SCALAR DOUBLE
// E/W to downmode to STRN [ft]
inline constexpr unsigned int SCP_EMOH = 0x005fd;// SCALAR DOUBLE
// altitude error from reference profile [ft]
inline constexpr unsigned int SCP_HERROR = 0x005ff;// SCALAR DOUBLE
// heading to HAC center [deg]
inline constexpr unsigned int SCP_PSC = 0x00601;// SCALAR DOUBLE
// estimated time to HAC [sec]
inline constexpr unsigned int SCP_P2TRNT = 0x00603;// SCALAR DOUBLE
// "OTT ST IN" indication
inline constexpr unsigned int SCP_OTT_ST_IN = 0x00605;// INTEGER SINGLE
// "SW TO MEP" indication
inline constexpr unsigned int SCP_SW_TO_MEP = 0x00606;// INTEGER SINGLE

// Entry guidance output
// angle-of-attack command [deg]
inline constexpr unsigned int SCP_ALPCMD = 0x00607;// SCALAR DOUBLE
// drag reference [fps^2]
inline constexpr unsigned int SCP_DREFP = 0x00609;// SCALAR DOUBLE
// roll angle command about body axis [deg]
inline constexpr unsigned int SCP_ROLLCMD = 0x0060b;// SCALAR DOUBLE
// roll ref [deg]
inline constexpr unsigned int SCP_ROLLREF = 0x0060d;// SCALAR DOUBLE
// altitude rate reference [fps]
inline constexpr unsigned int SCP_RDTREF = 0x0060f;// SCALAR DOUBLE
// derivative of range wrt drag [NM/fps^2]
inline constexpr unsigned int SCP_DRDD = 0x00611;// SCALAR DOUBLE
// Rdot feedback term [fps]
inline constexpr unsigned int SCP_DLRDOT = 0x00613;// SCALAR DOUBLE
// maximum heading error absolute value [rad]
inline constexpr unsigned int SCP_YL = 0x00615;// SCALAR DOUBLE
// scheduled angle of attack [deg]
inline constexpr unsigned int SCP_ACMD1 = 0x00617;// SCALAR DOUBLE
// entry guidance subphase counter
inline constexpr unsigned int SCP_ISLECT = 0x00619;// INTEGER SINGLE
// Entry guidance end flag
inline constexpr unsigned int SCP_EG_END = 0x0061a;// INTEGER SINGLE

// aerosurface position feedback
// left outboard elevon pos [deg]
inline constexpr unsigned int SCP_LOB_ELVN_POS_FDBK = 0x0061b;// SCALAR DOUBLE
// left inboard elevon pos [deg]
inline constexpr unsigned int SCP_LIB_ELVN_POS_FDBK = 0x0061d;// SCALAR DOUBLE
// right inboard elevon pos [deg]
inline constexpr unsigned int SCP_RIB_ELVN_POS_FDBK = 0x0061f;// SCALAR DOUBLE
// right outboard elevon pos [deg]
inline constexpr unsigned int SCP_ROB_ELVN_POS_FDBK = 0x00621;// SCALAR DOUBLE
// elevator pos [deg]
inline constexpr unsigned int SCP_DEFB = 0x00623;// SCALAR DOUBLE
// aileron pos [deg]
inline constexpr unsigned int SCP_DAFB = 0x00625;// SCALAR DOUBLE
// body flap pos [deg]
inline constexpr unsigned int SCP_DBFOFB = 0x00627;// SCALAR DOUBLE
// rudder pos [deg]
inline constexpr unsigned int SCP_DRFB = 0x00629;// SCALAR DOUBLE
// Speedbrake pos [deg]
inline constexpr unsigned int SCP_DSBFB_DEG = 0x0062b;// SCALAR DOUBLE
// Speedbrake pos [%]
inline constexpr unsigned int SCP_DSBFB_PCT = 0x0062d;// SCALAR DOUBLE
// speedbrake increment [deg]
inline constexpr unsigned int SCP_DSBPC = 0x0062f;// SCALAR DOUBLE

// Aerosurface command
// left outboard elevon command [deg]
inline constexpr unsigned int SCP_ELOC = 0x00631;// SCALAR DOUBLE
// left inboard elevon command [deg]
inline constexpr unsigned int SCP_ELIC = 0x00633;// SCALAR DOUBLE
// right inboard elevon command [deg]
inline constexpr unsigned int SCP_ERIC = 0x00635;// SCALAR DOUBLE
// right outboard elevon command [deg]
inline constexpr unsigned int SCP_EROC = 0x00637;// SCALAR DOUBLE
// body flap command [deg]
inline constexpr unsigned int SCP_DBFRC = 0x00639;// SCALAR DOUBLE
// rudder command [deg]
inline constexpr unsigned int SCP_RUDDER_CMD = 0x0063b;// SCALAR DOUBLE
// speedbrake command [deg]
inline constexpr unsigned int SCP_SPEED_BRAKE_CMD = 0x0063d;// SCALAR DOUBLE

// Speedbrake AUTO command [deg]
inline constexpr unsigned int SCP_SB_AUTO_CMD = 0x0063f;// SCALAR DOUBLE
