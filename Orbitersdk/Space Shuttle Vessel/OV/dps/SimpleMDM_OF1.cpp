...
namespace dps
{
	SimpleMDM_OF1::SimpleMDM_OF1( AtlantisSubsystemDirector* _director, BusManager* pBusManager ):SimpleMDM( _director, "SimpleMDM_OF1", pBusManager ),
		powered(true)
	{
	...
	void SimpleMDM_OF1::Rx( const BUS_ID id, void* data, const unsigned short datalen )
	{
