/****************************************************************************
  ...
  Simple Multiplexer/Demultiplexer Flight-Critical Forward 1 definition
...
/****************************************************************************
  ...
  **************************************************************************/
#ifndef _SIMPLEMDM_FF1_H_
#define _SIMPLEMDM_FF1_H_
...
namespace dps
{
	class SimpleMDM_FF1:public SimpleMDM
	{
		private:
			bool powered;
			...
			gnc::RadarAltimeter* pRA1;

		public:
			SimpleMDM_FF1( AtlantisSubsystemDirector* _director, BusManager* pBusManager );
			virtual ~SimpleMDM_FF1();
