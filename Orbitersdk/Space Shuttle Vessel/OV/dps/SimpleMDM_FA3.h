/****************************************************************************
  ...
  Simple Multiplexer/Demultiplexer Flight-Critical Aft 3 definition
...
/****************************************************************************
  ...
  **************************************************************************/
#ifndef _SIMPLEMDM_FA3_H_
#define _SIMPLEMDM_FA3_H_
...
namespace dps
{
	class SimpleMDM_FA3:public SimpleMDM
	{
		private:
			bool powered;
			...
			DiscOutPort dopIOM4_HI[16];
			DiscOutPort dopIOM4_LO[16];
		...
		public:
			SimpleMDM_FA3( AtlantisSubsystemDirector* _director, BusManager* pBusManager );
			virtual ~SimpleMDM_FA3();
