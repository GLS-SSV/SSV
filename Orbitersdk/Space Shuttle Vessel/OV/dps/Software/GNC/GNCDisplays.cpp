...
namespace dps
{
	...
	bool GNCDisplays::ItemInput_SPEC23( int item, const char* Data )
	{
		switch (item)
		{
			case 1:
		...
		switch (item)
		{
			...
			case 41:
				switch (GetMajorMode())
				{
					...
					case 304:
					case 305:
						WriteCOMPOOL_IS( SCP_RCS_MANF_OP_CL_STATUS_OVRD, 1 );
						break;
					default:
						return false;
				}
	...
	void GNCDisplays::OnPaint_SPEC23_PASS( vc::MDU* pMDU ) const
	{
