...
namespace dps
{
	...
	void Switch_RM::OnPreStep( double simt, double simdt, double mjd )
	{
		...
		WriteCOMPOOL_AIS( SCP_RHCETUS, 1, LH_RHC_PLUS_PITCH_TRIM_A & LH_RHC_PLUS_PITCH_TRIM_B, 2 );
		...
		WriteCOMPOOL_AIS( SCP_RHCETDS, 1, LH_RHC_MINUS_PITCH_TRIM_A & LH_RHC_MINUS_PITCH_TRIM_B, 2 );
		...
		WriteCOMPOOL_AIS( SCP_RHCATUS, 1, LH_RHC_PLUS_ROLL_TRIM_A & LH_RHC_PLUS_ROLL_TRIM_B, 2 );
		...
		WriteCOMPOOL_AIS( SCP_RHCATDS, 1, LH_RHC_MINUS_ROLL_TRIM_A & LH_RHC_MINUS_ROLL_TRIM_B, 2 );
		...
		WriteCOMPOOL_AIS( SCP_RHCETUS, 2, RH_RHC_PLUS_PITCH_TRIM_A & RH_RHC_PLUS_PITCH_TRIM_B, 2 );
		...
		WriteCOMPOOL_AIS( SCP_RHCETDS, 2, RH_RHC_MINUS_PITCH_TRIM_A & RH_RHC_MINUS_PITCH_TRIM_B, 2 );
		...
		WriteCOMPOOL_AIS( SCP_RHCATUS, 2, RH_RHC_PLUS_ROLL_TRIM_A & RH_RHC_PLUS_ROLL_TRIM_B, 2 );
		...
		WriteCOMPOOL_IS( SCP_SEL_LH_ADI_ATT_REF_PB, LH_ADI_ATTITUDE_REF_PB );
		...
		WriteCOMPOOL_IS( SCP_SEL_RH_ADI_ATT_REF_PB, RH_ADI_ATTITUDE_REF_PB );
