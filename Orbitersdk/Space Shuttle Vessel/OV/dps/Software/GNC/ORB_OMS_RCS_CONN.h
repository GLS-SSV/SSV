/****************************************************************************
  ...
  Orbit OMS/RCS Interconnect definition
  ...
  **************************************************************************/
#ifndef _dps_ORB_OMS_RCS_CONN_H_
#define _dps_ORB_OMS_RCS_CONN_H_
...
namespace dps
{
	class ORB_OMS_RCS_CONN:public SimpleGPCSoftware
	{
		private:
			unsigned short INTERCONNECT_INITIATION_FLAG;
			unsigned short PRE_SEQ_CMD_TERM_FLAG;
			unsigned short REPRESS_ACTIVE_FLAG;
			...
			unsigned short OMS_L_POD_TK_VLVS_A_CMD_1_OP;// V43K4270X
			unsigned short OMS_L_POD_TK_VLVS_A_CMD_1_CL;// V43K4271X
			unsigned short OMS_L_POD_OXDZR_ISLN_V_A_CMD_2_OP;// V43K4272X
			unsigned short OMS_L_POD_OXDZR_ISLN_V_A_CMD_2_CL;// V43K4273X
			unsigned short OMS_L_POD_TK_VLVS_B_CMD_1_OP;// V43K4274X
			unsigned short OMS_L_POD_TK_VLVS_B_CMD_1_CL;// V43K4275X
			unsigned short OMS_L_POD_OXDZR_ISLN_V_B_CMD_2_OP;// V43K4276X
			unsigned short OMS_L_POD_OXDZR_ISLN_V_B_CMD_2_CL;// V43K4277X
			unsigned short OMS_L_POD_FUEL_ISLN_VLV_A_CMD_2_OP;// V43K4372X
			unsigned short OMS_L_POD_FUEL_ISLN_VLV_A_CMD_2_CL;// V43K4373X
			unsigned short OMS_L_POD_FUEL_ISLN_VLV_B_CMD_2_OP;// V43K4376X
			unsigned short OMS_L_POD_FUEL_ISLN_VLV_B_CMD_2_CL;// V43K4377X

			unsigned short OMS_R_POD_TK_VLVS_A_CMD_1_OP;// V43K5270X
			unsigned short OMS_R_POD_TK_VLVS_A_CMD_1_CL;// V43K5271X
			unsigned short OMS_R_POD_OXDZR_ISLN_V_A_CMD_2_OP;// V43K5272X
			unsigned short OMS_R_POD_OXDZR_ISLN_V_A_CMD_2_CL;// V43K5273X
			unsigned short OMS_R_POD_TK_VLVS_B_CMD_1_OP;// V43K5274X
			unsigned short OMS_R_POD_TK_VLVS_B_CMD_1_CL;// V43K5275X
			unsigned short OMS_R_POD_OXDZR_ISLN_V_B_CMD_2_OP;// V43K5276X
			unsigned short OMS_R_POD_OXDZR_ISLN_V_B_CMD_2_CL;// V43K5277X
			unsigned short OMS_R_POD_FUEL_ISLN_VLV_A_CMD_2_OP;// V43K5372X
			unsigned short OMS_R_POD_FUEL_ISLN_VLV_A_CMD_2_CL;// V43K5373X
			unsigned short OMS_R_POD_FUEL_ISLN_VLV_B_CMD_2_OP;// V43K5376X
			unsigned short OMS_R_POD_FUEL_ISLN_VLV_B_CMD_2_CL;// V43K5377X
			...
			bool firstpass_stepa1_2;
			double timer_step2;
			double timer_stepa1_1;
			double timer_stepa1_2;
			bool timerena_step2;
			bool timerena_stepa1_1;
			bool timerena_stepa1_2;
		...
		public:
			explicit ORB_OMS_RCS_CONN( SimpleGPCSystem* _gpc );
			~ORB_OMS_RCS_CONN( void );
...
#endif// _dps_ORB_OMS_RCS_CONN_H_
