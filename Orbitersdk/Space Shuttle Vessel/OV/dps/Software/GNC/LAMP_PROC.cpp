...
namespace dps
{
	...
	void LAMP_PROC::OnPostStep( double simt, double simdt, double mjd )
	{
		...
		// G-LOAD
		if (((MM_CODE_304 == 1) && (LOAD_TOTAL >= LOAD_FLASH)) || (((MM_CODE_305 == 1) || (MM_CODE_602 == 1) || (MM_CODE_603 == 1)) && (NZ >= LOAD_FLASH)))
		{
			HI_G = 1;
			HUD_HI_G = 1;
		}
		...
		if (((MM_CODE_304 == 1) && (LOAD_TOTAL >= LOAD_LITE)) || (((MM_CODE_305 == 1) || (MM_CODE_602 == 1) || (MM_CODE_603 == 1)) && (NZ >= LOAD_LITE)))
		{
			HI_G_GAX = 1;
		}
		else
		...
		// SPEED BRAKE
		double SB_COMP = 0.0;
		if ((MM_CODE_304 == 1) || (MM_CODE_305 == 1))
		{
		...
		// output
		if (LAUTO_PLAMP == 1) WriteCOMPOOL_IS( SCP_FF1_IOM10_CH0_DATA, ReadCOMPOOL_IS( SCP_FF1_IOM10_CH0_DATA ) | 0x0200 );
		if (RAUTO_PLAMP == 1) WriteCOMPOOL_IS( SCP_FF3_IOM10_CH0_DATA, ReadCOMPOOL_IS( SCP_FF3_IOM10_CH0_DATA ) | 0x0200 );
		if (LCSS_PLAMP == 1) WriteCOMPOOL_IS( SCP_FF2_IOM10_CH0_DATA, ReadCOMPOOL_IS( SCP_FF2_IOM10_CH0_DATA ) | 0x0200 );
		if (RCSS_PLAMP == 1) WriteCOMPOOL_IS( SCP_FF4_IOM10_CH0_DATA, ReadCOMPOOL_IS( SCP_FF4_IOM10_CH0_DATA ) | 0x0200 );
		if (LGAIN_ENA_PLAMP == 1) WriteCOMPOOL_IS( SCP_FF1_IOM10_CH0_DATA, ReadCOMPOOL_IS( SCP_FF1_IOM10_CH0_DATA ) | 0x0080 );
		if (RGAIN_ENA_PLAMP == 1) WriteCOMPOOL_IS( SCP_FF3_IOM10_CH0_DATA, ReadCOMPOOL_IS( SCP_FF3_IOM10_CH0_DATA ) | 0x0080 );
		if (LAUTO_RYLAMP == 1) WriteCOMPOOL_IS( SCP_FF1_IOM10_CH0_DATA, ReadCOMPOOL_IS( SCP_FF1_IOM10_CH0_DATA ) | 0x0100 );
		if (RAUTO_RYLAMP == 1) WriteCOMPOOL_IS( SCP_FF3_IOM10_CH0_DATA, ReadCOMPOOL_IS( SCP_FF3_IOM10_CH0_DATA ) | 0x0100 );
		if (LCSS_RYLAMP == 1) WriteCOMPOOL_IS( SCP_FF2_IOM10_CH0_DATA, ReadCOMPOOL_IS( SCP_FF2_IOM10_CH0_DATA ) | 0x0100 );
		if (RCSS_RYLAMP == 1) WriteCOMPOOL_IS( SCP_FF4_IOM10_CH0_DATA, ReadCOMPOOL_IS( SCP_FF4_IOM10_CH0_DATA ) | 0x0100 );
		if (LGAIN_ENA_RYLAMP == 1) WriteCOMPOOL_IS( SCP_FF1_IOM10_CH0_DATA, ReadCOMPOOL_IS( SCP_FF1_IOM10_CH0_DATA ) | 0x0040 );
		if (RGAIN_ENA_RYLAMP == 1) WriteCOMPOOL_IS( SCP_FF3_IOM10_CH0_DATA, ReadCOMPOOL_IS( SCP_FF3_IOM10_CH0_DATA ) | 0x0040 );
		if (LAUTO_SBLAMP == 1) WriteCOMPOOL_IS( SCP_FF1_IOM10_CH0_DATA, ReadCOMPOOL_IS( SCP_FF1_IOM10_CH0_DATA ) | 0x0400 );
		if (RAUTO_SBLAMP == 1) WriteCOMPOOL_IS( SCP_FF3_IOM10_CH0_DATA, ReadCOMPOOL_IS( SCP_FF3_IOM10_CH0_DATA ) | 0x0400 );
		if (MNLSB_CMDR_O == 1) WriteCOMPOOL_IS( SCP_FF2_IOM10_CH0_DATA, ReadCOMPOOL_IS( SCP_FF2_IOM10_CH0_DATA ) | 0x0400 );
		if (MNLSB_PLT_O == 1) WriteCOMPOOL_IS( SCP_FF4_IOM10_CH0_DATA, ReadCOMPOOL_IS( SCP_FF4_IOM10_CH0_DATA ) | 0x0400 );
		if (LMNL_BFLAMP == 1) WriteCOMPOOL_IS( SCP_FF2_IOM10_CH0_DATA, ReadCOMPOOL_IS( SCP_FF2_IOM10_CH0_DATA ) | 0x0800 );
		if (RMNL_BFLAMP == 1) WriteCOMPOOL_IS( SCP_FF4_IOM10_CH0_DATA, ReadCOMPOOL_IS( SCP_FF4_IOM10_CH0_DATA ) | 0x0800 );
		if (LAUTO_BFLAMP == 1) WriteCOMPOOL_IS( SCP_FF1_IOM10_CH0_DATA, ReadCOMPOOL_IS( SCP_FF1_IOM10_CH0_DATA ) | 0x0800 );
		if (RAUTO_BFLAMP == 1) WriteCOMPOOL_IS( SCP_FF3_IOM10_CH0_DATA, ReadCOMPOOL_IS( SCP_FF3_IOM10_CH0_DATA ) | 0x0800 );
