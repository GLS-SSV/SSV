...
namespace dps
{
	...
	void SimpleFCOS_IO_GNC::input( void )
	{
		...
		if ((pGPC->ReadCOMPOOL_ID( SCP_COMMFAULT_WORD_1 ) & 0x00000008) == 0)
		{
			...
			InputMDM( MDM_FF4_Address, ModeControl_MDM_Transmit, ModuleAddress_IOM6, ChannelAddress_0, SCP_FF4_IOM6_CH0_DATA, bus );
		...
		if ((pGPC->ReadCOMPOOL_ID( SCP_COMMFAULT_WORD_1 ) & 0x00001000) == 0)
		{
			...
			InputMDM( MDM_FA1_Address, ModeControl_MDM_Transmit, ModuleAddress_IOM3, ChannelAddress_2, SCP_FA1_IOM3_CH2_DATA, bus );
			InputMDM( MDM_FA1_Address, ModeControl_MDM_Transmit, ModuleAddress_IOM5, ChannelAddress_0, SCP_FA1_IOM5_CH0_DATA, bus );
			InputMDM( MDM_FA1_Address, ModeControl_MDM_Transmit, ModuleAddress_IOM6, ChannelAddress_17, SCP_FA1_IOM6_CH17_DATA, bus );
			InputMDM( MDM_FA1_Address, ModeControl_MDM_Transmit, ModuleAddress_IOM6, ChannelAddress_21, SCP_FA1_IOM6_CH21_DATA, bus );
			InputMDM( MDM_FA1_Address, ModeControl_MDM_Transmit, ModuleAddress_IOM8, ChannelAddress_0, SCP_FA1_IOM8_CH0_DATA, bus );
			InputMDM( MDM_FA1_Address, ModeControl_MDM_Transmit, ModuleAddress_IOM11, ChannelAddress_0, SCP_FA1_IOM11_CH0_DATA, bus );
			InputMDM( MDM_FA1_Address, ModeControl_MDM_Transmit, ModuleAddress_IOM11, ChannelAddress_1, SCP_FA1_IOM11_CH1_DATA, bus );
			InputMDM( MDM_FA1_Address, ModeControl_MDM_Transmit, ModuleAddress_IOM11, ChannelAddress_2, SCP_FA1_IOM11_CH2_DATA, bus );
		...
		if ((pGPC->ReadCOMPOOL_ID( SCP_COMMFAULT_WORD_1 ) & 0x00002000) == 0)
		{
			...
			InputMDM( MDM_FA2_Address, ModeControl_MDM_Transmit, ModuleAddress_IOM3, ChannelAddress_1, SCP_FA2_IOM3_CH1_DATA, bus );
			InputMDM( MDM_FA2_Address, ModeControl_MDM_Transmit, ModuleAddress_IOM3, ChannelAddress_2, SCP_FA2_IOM3_CH2_DATA, bus );
			InputMDM( MDM_FA2_Address, ModeControl_MDM_Transmit, ModuleAddress_IOM5, ChannelAddress_0, SCP_FA2_IOM5_CH0_DATA, bus );
			InputMDM( MDM_FA2_Address, ModeControl_MDM_Transmit, ModuleAddress_IOM6, ChannelAddress_17, SCP_FA2_IOM6_CH17_DATA, bus );
			InputMDM( MDM_FA2_Address, ModeControl_MDM_Transmit, ModuleAddress_IOM6, ChannelAddress_21, SCP_FA2_IOM6_CH21_DATA, bus );
			InputMDM( MDM_FA2_Address, ModeControl_MDM_Transmit, ModuleAddress_IOM8, ChannelAddress_0, SCP_FA2_IOM8_CH0_DATA, bus );
			InputMDM( MDM_FA2_Address, ModeControl_MDM_Transmit, ModuleAddress_IOM11, ChannelAddress_0, SCP_FA2_IOM11_CH0_DATA, bus );
			InputMDM( MDM_FA2_Address, ModeControl_MDM_Transmit, ModuleAddress_IOM11, ChannelAddress_1, SCP_FA2_IOM11_CH1_DATA, bus );
			InputMDM( MDM_FA2_Address, ModeControl_MDM_Transmit, ModuleAddress_IOM11, ChannelAddress_2, SCP_FA2_IOM11_CH2_DATA, bus );
		...
		if ((pGPC->ReadCOMPOOL_ID( SCP_COMMFAULT_WORD_1 ) & 0x00004000) == 0)
		{
			...
			InputMDM( MDM_FA3_Address, ModeControl_MDM_Transmit, ModuleAddress_IOM3, ChannelAddress_1, SCP_FA3_IOM3_CH1_DATA, bus );
			InputMDM( MDM_FA3_Address, ModeControl_MDM_Transmit, ModuleAddress_IOM3, ChannelAddress_2, SCP_FA3_IOM3_CH2_DATA, bus );
			InputMDM( MDM_FA3_Address, ModeControl_MDM_Transmit, ModuleAddress_IOM5, ChannelAddress_0, SCP_FA3_IOM5_CH0_DATA, bus );
			InputMDM( MDM_FA3_Address, ModeControl_MDM_Transmit, ModuleAddress_IOM8, ChannelAddress_0, SCP_FA3_IOM8_CH0_DATA, bus );
			InputMDM( MDM_FA3_Address, ModeControl_MDM_Transmit, ModuleAddress_IOM11, ChannelAddress_0, SCP_FA3_IOM11_CH0_DATA, bus );
			InputMDM( MDM_FA3_Address, ModeControl_MDM_Transmit, ModuleAddress_IOM11, ChannelAddress_1, SCP_FA3_IOM11_CH1_DATA, bus );
			InputMDM( MDM_FA3_Address, ModeControl_MDM_Transmit, ModuleAddress_IOM11, ChannelAddress_2, SCP_FA3_IOM11_CH2_DATA, bus );
			InputMDM( MDM_FA3_Address, ModeControl_MDM_Transmit, ModuleAddress_IOM6, ChannelAddress_17, SCP_FA3_IOM6_CH17_DATA, bus );
			InputMDM( MDM_FA3_Address, ModeControl_MDM_Transmit, ModuleAddress_IOM6, ChannelAddress_18, SCP_FA3_IOM6_CH18_DATA, bus );
			InputMDM( MDM_FA3_Address, ModeControl_MDM_Transmit, ModuleAddress_IOM6, ChannelAddress_19, SCP_FA3_IOM6_CH19_DATA, bus );
			InputMDM( MDM_FA3_Address, ModeControl_MDM_Transmit, ModuleAddress_IOM6, ChannelAddress_20, SCP_FA3_IOM6_CH20_DATA, bus );
			InputMDM( MDM_FA3_Address, ModeControl_MDM_Transmit, ModuleAddress_IOM6, ChannelAddress_21, SCP_FA3_IOM6_CH21_DATA, bus );
		...
		if ((pGPC->ReadCOMPOOL_ID( SCP_COMMFAULT_WORD_1 ) & 0x00008000) == 0)
		{
			...
			InputMDM( MDM_FA4_Address, ModeControl_MDM_Transmit, ModuleAddress_IOM3, ChannelAddress_1, SCP_FA4_IOM3_CH1_DATA, bus );
			InputMDM( MDM_FA4_Address, ModeControl_MDM_Transmit, ModuleAddress_IOM3, ChannelAddress_2, SCP_FA4_IOM3_CH2_DATA, bus );
			InputMDM( MDM_FA4_Address, ModeControl_MDM_Transmit, ModuleAddress_IOM5, ChannelAddress_0, SCP_FA4_IOM5_CH0_DATA, bus );
			InputMDM( MDM_FA4_Address, ModeControl_MDM_Transmit, ModuleAddress_IOM6, ChannelAddress_17, SCP_FA4_IOM6_CH17_DATA, bus );
			InputMDM( MDM_FA4_Address, ModeControl_MDM_Transmit, ModuleAddress_IOM6, ChannelAddress_18, SCP_FA4_IOM6_CH18_DATA, bus );
			InputMDM( MDM_FA4_Address, ModeControl_MDM_Transmit, ModuleAddress_IOM6, ChannelAddress_19, SCP_FA4_IOM6_CH19_DATA, bus );
			InputMDM( MDM_FA4_Address, ModeControl_MDM_Transmit, ModuleAddress_IOM6, ChannelAddress_20, SCP_FA4_IOM6_CH20_DATA, bus );
			InputMDM( MDM_FA4_Address, ModeControl_MDM_Transmit, ModuleAddress_IOM6, ChannelAddress_21, SCP_FA4_IOM6_CH21_DATA, bus );
			InputMDM( MDM_FA4_Address, ModeControl_MDM_Transmit, ModuleAddress_IOM8, ChannelAddress_0, SCP_FA4_IOM8_CH0_DATA, bus );
			InputMDM( MDM_FA4_Address, ModeControl_MDM_Transmit, ModuleAddress_IOM11, ChannelAddress_0, SCP_FA4_IOM11_CH0_DATA, bus );
			InputMDM( MDM_FA4_Address, ModeControl_MDM_Transmit, ModuleAddress_IOM11, ChannelAddress_1, SCP_FA4_IOM11_CH1_DATA, bus );
			InputMDM( MDM_FA4_Address, ModeControl_MDM_Transmit, ModuleAddress_IOM11, ChannelAddress_2, SCP_FA4_IOM11_CH2_DATA, bus );
	...
	void SimpleFCOS_IO_GNC::output( void )
	{
		...
		if ((pGPC->ReadCOMPOOL_ID( SCP_COMMFAULT_WORD_1 ) & 0x00000001) == 0)
		{
			...
			OutputMDM( MDM_FF1_Address, ModeControl_MDM_Receive, ModuleAddress_IOM5, ChannelAddress_0, SCP_FF1_IOM5_CH0_DATA, bus );
			...
			OutputMDM( MDM_FF1_Address, ModeControl_MDM_Receive, ModuleAddress_IOM13, ChannelAddress_0, SCP_FF1_IOM13_CH0_DATA, bus );
		...
		else
		{
			...
			pGPC->SimpleCOMPOOL[SCP_FF1_IOM5_CH0_DATA] = 0;
			...
			pGPC->SimpleCOMPOOL[SCP_FF1_IOM13_CH0_DATA] = 0;
		...
		if ((pGPC->ReadCOMPOOL_ID( SCP_COMMFAULT_WORD_1 ) & 0x00000002) == 0)
		{
			...
			OutputMDM( MDM_FF2_Address, ModeControl_MDM_Receive, ModuleAddress_IOM5, ChannelAddress_0, SCP_FF2_IOM5_CH0_DATA, bus );
			...
			OutputMDM( MDM_FF2_Address, ModeControl_MDM_Receive, ModuleAddress_IOM13, ChannelAddress_0, SCP_FF2_IOM13_CH0_DATA, bus );
		...
		else
		{
			...
			pGPC->SimpleCOMPOOL[SCP_FF2_IOM5_CH0_DATA] = 0;
			...
			pGPC->SimpleCOMPOOL[SCP_FF2_IOM13_CH0_DATA] = 0;
		...
		if ((pGPC->ReadCOMPOOL_ID( SCP_COMMFAULT_WORD_1 ) & 0x00000004) == 0)
		{
			...
			OutputMDM( MDM_FF3_Address, ModeControl_MDM_Receive, ModuleAddress_IOM5, ChannelAddress_0, SCP_FF3_IOM5_CH0_DATA, bus );
			...
			OutputMDM( MDM_FF3_Address, ModeControl_MDM_Receive, ModuleAddress_IOM13, ChannelAddress_0, SCP_FF3_IOM13_CH0_DATA, bus );
		...
		else
		{
			...
			pGPC->SimpleCOMPOOL[SCP_FF3_IOM5_CH0_DATA] = 0;
			...
			pGPC->SimpleCOMPOOL[SCP_FF3_IOM13_CH0_DATA] = 0;
		...
		if ((pGPC->ReadCOMPOOL_ID( SCP_COMMFAULT_WORD_1 ) & 0x00000008) == 0)
		{
			...
			OutputMDM( MDM_FF4_Address, ModeControl_MDM_Receive, ModuleAddress_IOM5, ChannelAddress_0, SCP_FF4_IOM5_CH0_DATA, bus );
			...
			OutputMDM( MDM_FF4_Address, ModeControl_MDM_Receive, ModuleAddress_IOM13, ChannelAddress_0, SCP_FF4_IOM13_CH0_DATA, bus );
		}
		else
		{
			// reset outputs
			...
			pGPC->SimpleCOMPOOL[SCP_FF4_IOM5_CH0_DATA] = 0;
			...
			pGPC->SimpleCOMPOOL[SCP_FF4_IOM13_CH0_DATA] = 0;
		}
		...
		if ((pGPC->ReadCOMPOOL_ID( SCP_COMMFAULT_WORD_1 ) & 0x00001000) == 0)
		{
			OutputMDM( MDM_FA1_Address, ModeControl_MDM_Receive, ModuleAddress_IOM2, ChannelAddress_0, SCP_FA1_IOM2_CH0_DATA, bus );
			...
			OutputMDM( MDM_FA1_Address, ModeControl_MDM_Receive, ModuleAddress_IOM7, ChannelAddress_1, SCP_FA1_IOM7_CH1_DATA, bus );
			OutputMDM( MDM_FA1_Address, ModeControl_MDM_Receive, ModuleAddress_IOM7, ChannelAddress_2, SCP_FA1_IOM7_CH2_DATA, bus );
			OutputMDM( MDM_FA1_Address, ModeControl_MDM_Receive, ModuleAddress_IOM10, ChannelAddress_0, SCP_FA1_IOM10_CH0_DATA, bus );
			OutputMDM( MDM_FA1_Address, ModeControl_MDM_Receive, ModuleAddress_IOM12, ChannelAddress_1, SCP_FA1_IOM12_CH1_DATA, bus );
			OutputMDM( MDM_FA1_Address, ModeControl_MDM_Receive, ModuleAddress_IOM15, ChannelAddress_0, SCP_FA1_IOM15_CH0_DATA, bus );
			OutputMDM( MDM_FA1_Address, ModeControl_MDM_Receive, ModuleAddress_IOM15, ChannelAddress_1, SCP_FA1_IOM15_CH1_DATA, bus );
			OutputMDM( MDM_FA1_Address, ModeControl_MDM_Receive, ModuleAddress_IOM15, ChannelAddress_2, SCP_FA1_IOM15_CH2_DATA, bus );
			OutputMDM( MDM_FA1_Address, ModeControl_MDM_Receive, ModuleAddress_IOM4, ChannelAddress_7, SCP_FA1_IOM4_CH7_DATA, bus );
			OutputMDM( MDM_FA1_Address, ModeControl_MDM_Receive, ModuleAddress_IOM4, ChannelAddress_8, SCP_FA1_IOM4_CH8_DATA, bus );
		}
		else
		{
			// reset outputs
			pGPC->SimpleCOMPOOL[SCP_FA1_IOM2_CH0_DATA] = 0;
			...
			pGPC->SimpleCOMPOOL[SCP_FA1_IOM7_CH1_DATA] = 0;
			pGPC->SimpleCOMPOOL[SCP_FA1_IOM7_CH2_DATA] = 0;
			pGPC->SimpleCOMPOOL[SCP_FA1_IOM10_CH0_DATA] = 0;
			pGPC->SimpleCOMPOOL[SCP_FA1_IOM12_CH1_DATA] = 0;
			pGPC->SimpleCOMPOOL[SCP_FA1_IOM15_CH0_DATA] = 0;
			pGPC->SimpleCOMPOOL[SCP_FA1_IOM15_CH1_DATA] = 0;
			pGPC->SimpleCOMPOOL[SCP_FA1_IOM15_CH2_DATA] = 0;
			pGPC->SimpleCOMPOOL[SCP_FA1_IOM4_CH7_DATA] = 0;
			pGPC->SimpleCOMPOOL[SCP_FA1_IOM4_CH8_DATA] = 0;
		}
		...
		if ((pGPC->ReadCOMPOOL_ID( SCP_COMMFAULT_WORD_1 ) & 0x00002000) == 0)
		{
			OutputMDM( MDM_FA2_Address, ModeControl_MDM_Receive, ModuleAddress_IOM2, ChannelAddress_0, SCP_FA2_IOM2_CH0_DATA, bus );
			...
			OutputMDM( MDM_FA2_Address, ModeControl_MDM_Receive, ModuleAddress_IOM7, ChannelAddress_1, SCP_FA2_IOM7_CH1_DATA, bus );
			OutputMDM( MDM_FA2_Address, ModeControl_MDM_Receive, ModuleAddress_IOM7, ChannelAddress_2, SCP_FA2_IOM7_CH2_DATA, bus );
			OutputMDM( MDM_FA2_Address, ModeControl_MDM_Receive, ModuleAddress_IOM10, ChannelAddress_0, SCP_FA2_IOM10_CH0_DATA, bus );
			OutputMDM( MDM_FA2_Address, ModeControl_MDM_Receive, ModuleAddress_IOM12, ChannelAddress_1, SCP_FA2_IOM12_CH1_DATA, bus );
			OutputMDM( MDM_FA2_Address, ModeControl_MDM_Receive, ModuleAddress_IOM15, ChannelAddress_0, SCP_FA2_IOM15_CH0_DATA, bus );
			OutputMDM( MDM_FA2_Address, ModeControl_MDM_Receive, ModuleAddress_IOM15, ChannelAddress_1, SCP_FA2_IOM15_CH1_DATA, bus );
			OutputMDM( MDM_FA2_Address, ModeControl_MDM_Receive, ModuleAddress_IOM15, ChannelAddress_2, SCP_FA2_IOM15_CH2_DATA, bus );
			OutputMDM( MDM_FA2_Address, ModeControl_MDM_Receive, ModuleAddress_IOM4, ChannelAddress_7, SCP_FA2_IOM4_CH7_DATA, bus );
			OutputMDM( MDM_FA2_Address, ModeControl_MDM_Receive, ModuleAddress_IOM4, ChannelAddress_8, SCP_FA2_IOM4_CH8_DATA, bus );
		}
		else
		{
			// reset outputs
			pGPC->SimpleCOMPOOL[SCP_FA2_IOM2_CH0_DATA] = 0;
			...
			pGPC->SimpleCOMPOOL[SCP_FA2_IOM7_CH1_DATA] = 0;
			pGPC->SimpleCOMPOOL[SCP_FA2_IOM7_CH2_DATA] = 0;
			pGPC->SimpleCOMPOOL[SCP_FA2_IOM10_CH0_DATA] = 0;
			pGPC->SimpleCOMPOOL[SCP_FA2_IOM12_CH1_DATA] = 0;
			pGPC->SimpleCOMPOOL[SCP_FA2_IOM15_CH0_DATA] = 0;
			pGPC->SimpleCOMPOOL[SCP_FA2_IOM15_CH1_DATA] = 0;
			pGPC->SimpleCOMPOOL[SCP_FA2_IOM15_CH2_DATA] = 0;
			pGPC->SimpleCOMPOOL[SCP_FA2_IOM4_CH7_DATA] = 0;
			pGPC->SimpleCOMPOOL[SCP_FA2_IOM4_CH8_DATA] = 0;
		}
		...
		if ((pGPC->ReadCOMPOOL_ID( SCP_COMMFAULT_WORD_1 ) & 0x00004000) == 0)
		{
			OutputMDM( MDM_FA3_Address, ModeControl_MDM_Receive, ModuleAddress_IOM2, ChannelAddress_0, SCP_FA3_IOM2_CH0_DATA, bus );
			...
			OutputMDM( MDM_FA3_Address, ModeControl_MDM_Receive, ModuleAddress_IOM7, ChannelAddress_1, SCP_FA3_IOM7_CH1_DATA, bus );
			OutputMDM( MDM_FA3_Address, ModeControl_MDM_Receive, ModuleAddress_IOM7, ChannelAddress_2, SCP_FA3_IOM7_CH2_DATA, bus );
			OutputMDM( MDM_FA3_Address, ModeControl_MDM_Receive, ModuleAddress_IOM10, ChannelAddress_0, SCP_FA3_IOM10_CH0_DATA, bus );
			OutputMDM( MDM_FA3_Address, ModeControl_MDM_Receive, ModuleAddress_IOM12, ChannelAddress_1, SCP_FA3_IOM12_CH1_DATA, bus );
			OutputMDM( MDM_FA3_Address, ModeControl_MDM_Receive, ModuleAddress_IOM15, ChannelAddress_0, SCP_FA3_IOM15_CH0_DATA, bus );
			OutputMDM( MDM_FA3_Address, ModeControl_MDM_Receive, ModuleAddress_IOM15, ChannelAddress_1, SCP_FA3_IOM15_CH1_DATA, bus );
			OutputMDM( MDM_FA3_Address, ModeControl_MDM_Receive, ModuleAddress_IOM15, ChannelAddress_2, SCP_FA3_IOM15_CH2_DATA, bus );
			OutputMDM( MDM_FA3_Address, ModeControl_MDM_Receive, ModuleAddress_IOM4, ChannelAddress_7, SCP_FA3_IOM4_CH7_DATA, bus );
			OutputMDM( MDM_FA3_Address, ModeControl_MDM_Receive, ModuleAddress_IOM4, ChannelAddress_8, SCP_FA3_IOM4_CH8_DATA, bus );
		}
		else
		{
			// reset outputs
			pGPC->SimpleCOMPOOL[SCP_FA3_IOM2_CH0_DATA] = 0;
			...
			pGPC->SimpleCOMPOOL[SCP_FA3_IOM7_CH1_DATA] = 0;
			pGPC->SimpleCOMPOOL[SCP_FA3_IOM7_CH2_DATA] = 0;
			pGPC->SimpleCOMPOOL[SCP_FA3_IOM10_CH0_DATA] = 0;
			pGPC->SimpleCOMPOOL[SCP_FA3_IOM12_CH1_DATA] = 0;
			pGPC->SimpleCOMPOOL[SCP_FA3_IOM15_CH0_DATA] = 0;
			pGPC->SimpleCOMPOOL[SCP_FA3_IOM15_CH1_DATA] = 0;
			pGPC->SimpleCOMPOOL[SCP_FA3_IOM15_CH2_DATA] = 0;
			pGPC->SimpleCOMPOOL[SCP_FA3_IOM4_CH7_DATA] = 0;
			pGPC->SimpleCOMPOOL[SCP_FA3_IOM4_CH8_DATA] = 0;
		}
		...
		if ((pGPC->ReadCOMPOOL_ID( SCP_COMMFAULT_WORD_1 ) & 0x00008000) == 0)
		{
			OutputMDM( MDM_FA4_Address, ModeControl_MDM_Receive, ModuleAddress_IOM2, ChannelAddress_0, SCP_FA4_IOM2_CH0_DATA, bus );
			...
			OutputMDM( MDM_FA4_Address, ModeControl_MDM_Receive, ModuleAddress_IOM7, ChannelAddress_1, SCP_FA4_IOM7_CH1_DATA, bus );
			OutputMDM( MDM_FA4_Address, ModeControl_MDM_Receive, ModuleAddress_IOM7, ChannelAddress_2, SCP_FA4_IOM7_CH2_DATA, bus );
			OutputMDM( MDM_FA4_Address, ModeControl_MDM_Receive, ModuleAddress_IOM10, ChannelAddress_0, SCP_FA4_IOM10_CH0_DATA, bus );
			OutputMDM( MDM_FA4_Address, ModeControl_MDM_Receive, ModuleAddress_IOM12, ChannelAddress_1, SCP_FA4_IOM12_CH1_DATA, bus );
			OutputMDM( MDM_FA4_Address, ModeControl_MDM_Receive, ModuleAddress_IOM15, ChannelAddress_0, SCP_FA4_IOM15_CH0_DATA, bus );
			OutputMDM( MDM_FA4_Address, ModeControl_MDM_Receive, ModuleAddress_IOM15, ChannelAddress_1, SCP_FA4_IOM15_CH1_DATA, bus );
			OutputMDM( MDM_FA4_Address, ModeControl_MDM_Receive, ModuleAddress_IOM15, ChannelAddress_2, SCP_FA4_IOM15_CH2_DATA, bus );
			OutputMDM( MDM_FA4_Address, ModeControl_MDM_Receive, ModuleAddress_IOM4, ChannelAddress_7, SCP_FA4_IOM4_CH7_DATA, bus );
			OutputMDM( MDM_FA4_Address, ModeControl_MDM_Receive, ModuleAddress_IOM4, ChannelAddress_8, SCP_FA4_IOM4_CH8_DATA, bus );
		}
		else
		{
			// reset outputs
			pGPC->SimpleCOMPOOL[SCP_FA4_IOM2_CH0_DATA] = 0;
			...
			pGPC->SimpleCOMPOOL[SCP_FA4_IOM7_CH1_DATA] = 0;
			pGPC->SimpleCOMPOOL[SCP_FA4_IOM7_CH2_DATA] = 0;
			pGPC->SimpleCOMPOOL[SCP_FA4_IOM10_CH0_DATA] = 0;
			pGPC->SimpleCOMPOOL[SCP_FA4_IOM12_CH1_DATA] = 0;
			pGPC->SimpleCOMPOOL[SCP_FA4_IOM15_CH0_DATA] = 0;
			pGPC->SimpleCOMPOOL[SCP_FA4_IOM15_CH1_DATA] = 0;
			pGPC->SimpleCOMPOOL[SCP_FA4_IOM15_CH2_DATA] = 0;
			pGPC->SimpleCOMPOOL[SCP_FA4_IOM4_CH7_DATA] = 0;
			pGPC->SimpleCOMPOOL[SCP_FA4_IOM4_CH8_DATA] = 0;
		}
