...
namespace vc
{
	...
	void PanelA7A3_SPDS::DefineVC( void )
	{
		...
		pPAYLOAD_RELEASE_MN_A->SetMouseRegion( AID_A7A3_SPDS, 0.259781f, 0.590850f, 0.309601f, 0.638679f );// TODO
		...
		pPAYLOAD_RELEASE_MN_B->SetMouseRegion( AID_A7A3_SPDS, 0.259781f, 0.590850f, 0.309601f, 0.638679f );// TODO
		...
		pPEDESTAL_DRIVE_XFER_MN_A->SetMouseRegion( AID_A7A3_SPDS, 0.259781f, 0.590850f, 0.309601f, 0.638679f );// TODO
		...
		pPEDESTAL_DRIVE_XFER_MN_B->SetMouseRegion( AID_A7A3_SPDS, 0.259781f, 0.590850f, 0.309601f, 0.638679f );// TODO

		pPAYLOAD_RELEASE_SYS_A_ARM->DefineGroup( GRP_S1_A7A3_SPDS_VC );
		pPAYLOAD_RELEASE_SYS_A_ARM->SetInitialAnimState( 0.5 );
		pPAYLOAD_RELEASE_SYS_A_ARM->SetReference(_V( -0.734, 1.99, 14.685 ), switch_rot );// TODO
		pPAYLOAD_RELEASE_SYS_A_ARM->SetMouseRegion( AID_A7A3_SPDS, 0.379877f, 0.609586f, 0.422314f, 0.793425f );// TODO
		...
		pPAYLOAD_RELEASE_SYS_B_ARM->SetReference(_V( -0.734, 1.99, 14.685 ), switch_rot );// TODO
		pPAYLOAD_RELEASE_SYS_B_ARM->SetMouseRegion( AID_A7A3_SPDS, 0.379877f, 0.609586f, 0.422314f, 0.793425f );// TODO
		...
		pPAYLOAD_RELEASE_SYS_A_FIRE->SetReference(_V( -0.734, 1.99, 14.685 ), switch_rot );// TODO
		pPAYLOAD_RELEASE_SYS_A_FIRE->SetMouseRegion( AID_A7A3_SPDS, 0.379877f, 0.609586f, 0.422314f, 0.793425f );// TODO
		...
		pPAYLOAD_RELEASE_SYS_B_FIRE->SetReference(_V( -0.734, 1.99, 14.685 ), switch_rot );// TODO
		pPAYLOAD_RELEASE_SYS_B_FIRE->SetMouseRegion( AID_A7A3_SPDS, 0.379877f, 0.609586f, 0.422314f, 0.793425f );// TODO
		...
		pPEDESTAL_DRIVE_XFER_SYS_A_ARM->SetReference(_V( -0.734, 1.99, 14.685 ), switch_rot );// TODO
		pPEDESTAL_DRIVE_XFER_SYS_A_ARM->SetMouseRegion( AID_A7A3_SPDS, 0.379877f, 0.609586f, 0.422314f, 0.793425f );// TODO
		...
		pPEDESTAL_DRIVE_XFER_SYS_B_ARM->SetReference(_V( -0.734, 1.99, 14.685 ), switch_rot );// TODO
		pPEDESTAL_DRIVE_XFER_SYS_B_ARM->SetMouseRegion( AID_A7A3_SPDS, 0.379877f, 0.609586f, 0.422314f, 0.793425f );// TODO
		...
		pPEDESTAL_DRIVE_XFER_SYS_A_FIRE->SetReference(_V( -0.734, 1.99, 14.685 ), switch_rot );// TODO
		pPEDESTAL_DRIVE_XFER_SYS_A_FIRE->SetMouseRegion( AID_A7A3_SPDS, 0.379877f, 0.609586f, 0.422314f, 0.793425f );// TODO
		...
		pPEDESTAL_DRIVE_XFER_SYS_B_FIRE->SetReference(_V( -0.734, 1.99, 14.685 ), switch_rot );// TODO
		pPEDESTAL_DRIVE_XFER_SYS_B_FIRE->SetMouseRegion( AID_A7A3_SPDS, 0.379877f, 0.609586f, 0.422314f, 0.793425f );// TODO
		...
		pYo_DRIVE_POS_PRIMARY_INBD->DefineMeshGroups( GetVCMeshIndex(), GRP_DS11_U_A7A3_SPDS_VC, GRP_DS11_U_A7A3_SPDS_VC );
		pYo_DRIVE_POS_PRIMARY_BERTHED->DefineMeshGroups( GetVCMeshIndex(), GRP_DS12_U_A7A3_SPDS_VC, GRP_DS12_U_A7A3_SPDS_VC );
		pYo_DRIVE_POS_PRIMARY_OUTBD->DefineMeshGroups( GetVCMeshIndex(), GRP_DS13_U_A7A3_SPDS_VC, GRP_DS13_U_A7A3_SPDS_VC );
		pYo_DRIVE_POS_SECONDARY_INBD->DefineMeshGroups( GetVCMeshIndex(), GRP_DS14_U_A7A3_SPDS_VC, GRP_DS14_U_A7A3_SPDS_VC );
		pYo_DRIVE_POS_SECONDARY_BERTHED->DefineMeshGroups( GetVCMeshIndex(), GRP_DS15_U_A7A3_SPDS_VC, GRP_DS15_U_A7A3_SPDS_VC );
		pYo_DRIVE_POS_SECONDARY_OUTBD->DefineMeshGroups( GetVCMeshIndex(), GRP_DS16_U_A7A3_SPDS_VC, GRP_DS16_U_A7A3_SPDS_VC );
		pRDU_PRIMARY_REBERTH->DefineMeshGroups( GetVCMeshIndex(), GRP_DS17_U_A7A3_SPDS_VC, GRP_DS17_U_A7A3_SPDS_VC );
		pRDU_PRIMARY_STOW->DefineMeshGroups( GetVCMeshIndex(), GRP_DS18_U_A7A3_SPDS_VC, GRP_DS18_U_A7A3_SPDS_VC );
		pRDU_PRIMARY_DEPLOY->DefineMeshGroups( GetVCMeshIndex(), GRP_DS19_U_A7A3_SPDS_VC, GRP_DS19_U_A7A3_SPDS_VC );
		pRDU_SECONDARY_REBERTH->DefineMeshGroups( GetVCMeshIndex(), GRP_DS20_U_A7A3_SPDS_VC, GRP_DS20_U_A7A3_SPDS_VC );
		pRDU_SECONDARY_STOW->DefineMeshGroups( GetVCMeshIndex(), GRP_DS21_U_A7A3_SPDS_VC, GRP_DS21_U_A7A3_SPDS_VC );
		pRDU_SECONDARY_DEPLOY->DefineMeshGroups( GetVCMeshIndex(), GRP_DS22_U_A7A3_SPDS_VC, GRP_DS22_U_A7A3_SPDS_VC );
		return;
	}
	...
	void PanelA7A3_SPDS::RegisterVC( void )
	{
		...
		oapiVCSetAreaClickmode_Quadrilateral( AID_A7A3_SPDS,
			_V( 0.23624, 0.15522, 0.0 ) + ofs, _V( 0.23624, 0.15522, -0.3046 ) + ofs,// TODO
	...
	void PanelA7A3_SPDS::OnPreStep( double simt, double simdt, double mjd )
	{
		...
		if (dipPAYLOAD_RELEASE_MN_B && dipPAYLOAD_RELEASE_SYS_A_ARM)
		{
		...
		if (dipPEDESTAL_DRIVE_XFER_MN_B && dipPEDESTAL_DRIVE_XFER_SYS_A_ARM)
		{
