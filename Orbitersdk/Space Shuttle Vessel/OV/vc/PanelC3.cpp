...
namespace vc
{
	...
	void PanelC3::RegisterVC()
	{
		...
		oapiVCSetAreaClickmode_Quadrilateral( AID_C3_HI_1,// A1 bottom center
			...
			_V( -0.070189, 1.747687, 14.166249 ) + ofs, _V( 0.035453, 1.747687, 14.166249 ) + ofs );

		oapiVCSetAreaClickmode_Quadrilateral( AID_C3_HI_2,// A6
			_V( -0.260118, 1.746585, 14.1557 ) + ofs, _V( -0.049054, 1.746585, 14.1557 ) + ofs,
			_V( -0.260118, 1.724292, 13.943507 ) + ofs, _V( -0.049054, 1.724292, 13.943507 ) + ofs );
		...
		oapiVCSetAreaClickmode_Quadrilateral( AID_C3_HI_3,// A7 SRB PB
			...
			_V( 0.015283, 1.738598, 14.079697 ) + ofs, _V( 0.046753, 1.738598, 14.079697 ) + ofs );
		...
		oapiVCSetAreaClickmode_Quadrilateral( AID_C3_HI_4,// A7 ET PB
			...
			_V( 0.102901, 1.738598, 14.079697 ) + ofs, _V( 0.134511, 1.738598, 14.079697 ) + ofs );
		...
		oapiVCSetAreaClickmode_Quadrilateral( AID_C3_LO_1,// A1 top half
			...
			_V( -0.260118, 1.730074, 14.259899 ) + ofs, _V( 0.168355, 1.730074, 14.259899 ) + ofs );
		...
		oapiVCSetAreaClickmode_Quadrilateral( AID_C3_LO_2,// A1 bottom left
			...
			_V( -0.236096, 1.722124, 14.18445 ) + ofs, _V( -0.077394, 1.722124, 14.18445 ) + ofs );
		...
		oapiVCSetAreaClickmode_Quadrilateral( AID_C3_LO_3,// A1 bottom right
			...
			_V( 0.052127, 1.722179, 14.1849 ) + ofs, _V( 0.142307, 1.722179, 14.1849 ) + ofs );
		...
		oapiVCSetAreaClickmode_Quadrilateral( AID_C3_LO_4,// A7 SRB SW
			...
			_V( -0.020578, 1.711311, 14.081262 ) + ofs, _V( 0.005583, 1.711311, 14.081262 ) + ofs );
		...
		oapiVCSetAreaClickmode_Quadrilateral( AID_C3_LO_5,// A7 ET SW
			...
			_V( 0.069115, 1.70853, 14.055056 ) + ofs, _V( 0.097001, 1.70853, 14.055056 ) + ofs );
		...
		oapiVCSetAreaClickmode_Quadrilateral( AID_C3_LO_6,// A7 top right
			...
			_V( 0.174504, 1.708229, 14.0522 ) + ofs, _V( 0.221737, 1.708229, 14.0522 ) + ofs );
		...
		/*oapiVCSetAreaClickmode_Quadrilateral( AID_C3_LO_7,// A7 bottom
			...
			_V( -0.019446, 1.699939, 13.9734 ) + ofs, _V( 0.223501, 1.699939, 13.9734 ) + ofs );*/

		oapiVCSetAreaClickmode_Quadrilateral( AID_C3_LO_8,// A5
			_V( -0.232258, 1.694329, 13.92 ) + ofs, _V( 0.225643, 1.694329, 13.92 ) + ofs,
			_V( -0.232258, 1.680539, 13.7888 ) + ofs, _V( 0.225643, 1.680539, 13.7888 ) + ofs );
	...
	void PanelC3::OnPreStep( double simt, double simdt, double mjd )
	{
		...
		if (dipOMSArmLeftArm.IsSet())
		{
			dopOMSArmLeftArm_1.SetLine( 28.0f );
			dopOMSArmLeftArm_1_TM.SetLine( 28.0f );
			dopOMSArmLeftArm_2.SetLine( 28.0f );
			dopOMSArmLeftArm_2_TM.SetLine( 28.0f );
		}
		else
		{
			dopOMSArmLeftArm_1.ResetLine();
			dopOMSArmLeftArm_1_TM.ResetLine();
			dopOMSArmLeftArm_2.ResetLine();
			dopOMSArmLeftArm_2_TM.ResetLine();
		}

		if (dipOMSArmLeftArmPress.IsSet())
		{
			dopOMSArmLeftArmPress_1.SetLine( 28.0f );
			dopOMSArmLeftArmPress_1_TM.SetLine( 28.0f );
			dopOMSArmLeftArmPress_2.SetLine( 28.0f );
			dopOMSArmLeftArmPress_2_TM.SetLine( 28.0f );
		}
		else
		{
			dopOMSArmLeftArmPress_1.ResetLine();
			dopOMSArmLeftArmPress_1_TM.ResetLine();
			dopOMSArmLeftArmPress_2.ResetLine();
			dopOMSArmLeftArmPress_2_TM.ResetLine();
		}

		if (dipOMSArmRightArm.IsSet())
		{
			dopOMSArmRightArm_1.SetLine( 28.0f );
			dopOMSArmRightArm_1_TM.SetLine( 28.0f );
			dopOMSArmRightArm_2.SetLine( 28.0f );
			dopOMSArmRightArm_2_TM.SetLine( 28.0f );
		}
		else
		{
			dopOMSArmRightArm_1.ResetLine();
			dopOMSArmRightArm_1_TM.ResetLine();
			dopOMSArmRightArm_2.ResetLine();
			dopOMSArmRightArm_2_TM.ResetLine();
		}

		if (dipOMSArmRightArmPress.IsSet())
		{
			dopOMSArmRightArmPress_1.SetLine( 28.0f );
			dopOMSArmRightArmPress_1_TM.SetLine( 28.0f );
			dopOMSArmRightArmPress_2.SetLine( 28.0f );
			dopOMSArmRightArmPress_2_TM.SetLine( 28.0f );
		}
		else
		{
			dopOMSArmRightArmPress_1.ResetLine();
			dopOMSArmRightArmPress_1_TM.ResetLine();
			dopOMSArmRightArmPress_2.ResetLine();
			dopOMSArmRightArmPress_2_TM.ResetLine();
		}
		return;
	}
	...
	void PanelC3::Realize()
	{
		...
		pBundle = STS()->BundleManager()->CreateBundle( "MDM_FA1_IOM3_CH1", 16 );
		dopOMSArmLeftArmPress_2_TM.Connect( pBundle, 6 );
		dopOMSArmLeftArm_2_TM.Connect( pBundle, 7 );

		pBundle = STS()->BundleManager()->CreateBundle( "MDM_FA2_IOM3_CH1", 16 );
		dopOMSArmRightArmPress_2_TM.Connect( pBundle, 6 );
		dopOMSArmRightArm_2_TM.Connect( pBundle, 7 );

		pBundle = STS()->BundleManager()->CreateBundle( "MDM_FA3_IOM3_CH1", 16 );
		dopOMSArmLeftArmPress_1_TM.Connect( pBundle, 6 );
		dopOMSArmLeftArm_1_TM.Connect( pBundle, 7 );

		pBundle = STS()->BundleManager()->CreateBundle( "MDM_FA4_IOM3_CH1", 16 );
		dopOMSArmRightArmPress_1_TM.Connect( pBundle, 6 );
		dopOMSArmRightArm_1_TM.Connect( pBundle, 7 );
		...
		DiscreteBundle* pBundleC3_C = STS()->BundleManager()->CreateBundle( "C3_INTERNAL_C", 6 );
		pOMSArm[LEFT]->ConnectPort( 2, pBundleC3_C, 0 );// ARM
		...
		dopOMSArmLeftArm_2.Connect( pBundle, 1 );// ARM 2
		dopOMSArmLeftArmPress_1.Connect( pBundle, 2 );// ARM/PRESS 1
		dopOMSArmLeftArmPress_2.Connect( pBundle, 3 );// ARM/PRESS 2
		dopOMSArmRightArm_1.Connect( pBundle, 8 );// ARM 1
		dopOMSArmRightArm_2.Connect( pBundle, 9 );// ARM 2
		dopOMSArmRightArmPress_1.Connect( pBundle, 10 );// ARM/PRESS 1
		dopOMSArmRightArmPress_2.Connect( pBundle, 11 );// ARM/PRESS 2
