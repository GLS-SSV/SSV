...
namespace vc
{
	...
	void PanelC3::DefineVC()
	{
		...
		pCautionWarningMemory->SetMouseRegion( AID_C3, 0.806681f, 0.750891f, 0.839492f, 0.823358f );
		...
		pCautionWarningMode->SetMouseRegion( AID_C3, 0.853024f, 0.750891f, 0.899063f, 0.823358f );
		return;
	}
