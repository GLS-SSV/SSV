...
void FMC1::Realize( void )
{
	...
	RH_VENTS_1_2_MOTOR_1_CLOSE_B.Connect( pBundle, 0 );
	RH_VENTS_1_2_MOTOR_1_OPEN_B.Connect( pBundle, 1 );
	RH_VENTS_1_2_MOTOR_1_PURGE_B.Connect( pBundle, 2 );
	F_MANF_ISOV_NO_1_OP.Connect( pBundle, 3 );
	F_OX_TK_ISOV_345_OP_A.Connect( pBundle, 5 );
	F_OX_TK_ISOV_345_CL_B.Connect( pBundle, 6 );
	F_TK_ISOV_345_CL_A.Connect( pBundle, 7 );

	pBundle = BundleManager()->CreateBundle( "MDM_FF1_IOM10_CH0", 16 );
	RH_VENTS_1_2_MOTOR_1_CLOSE_A.Connect( pBundle, 0 );
	RH_VENTS_1_2_MOTOR_1_OPEN_A.Connect( pBundle, 1 );
	RH_VENTS_1_2_MOTOR_1_PURGE_A.Connect( pBundle, 2 );
	F_FU_TK_ISOV_345_OP_A.Connect( pBundle, 10 );
	F_FU_TK_ISOV_345_CL_B.Connect( pBundle, 11 );

	pBundle = BundleManager()->CreateBundle( "MDM_FF3_IOM2_CH0", 16 );
	F_MANF_ISOV_NO_1_CL_A.Connect( pBundle, 4 );

	pBundle = BundleManager()->CreateBundle( "MDM_FF3_IOM10_CH0", 16 );
	F_MANF_ISOV_NO_1_CL_B.Connect( pBundle, 15 );
...
void FMC1::OnPreStep( double simt, double simdt, double mjd )
{
	...
	bool K1 = (F_MANF_ISOV_NO_1_OP.IsSet( 26.0f ) || FWD_RCS_MANIFOLD_ISOLATION_1_SW_OPEN) && !(FWD_RCS_MANIFOLD_ISOLATION_1_SW_CLOSE || (F_FU_MANF_ISOV_1_OP && F_OX_MANF_ISOV_1_OP));// OP
	bool K2 = (F_MANF_ISOV_NO_1_CL_A.IsSet( 26.0f ) || F_MANF_ISOV_NO_1_CL_B.IsSet( 26.0f ) || FWD_RCS_MANIFOLD_ISOLATION_1_SW_CLOSE) && !(FWD_RCS_MANIFOLD_ISOLATION_1_SW_OPEN || (F_FU_MANF_ISOV_1_CL && F_OX_MANF_ISOV_1_CL));// CL
	...
	bool K3 = (F_FU_TK_ISOV_345_OP_A.IsSet( 26.0f ) || FWD_RCS_TANK_ISOLATION_345_SW_OPEN) && !(FWD_RCS_TANK_ISOLATION_345_SW_CLOSE || F_FU_TK_ISOV_345_OP);// OP
	bool K4 = (F_TK_ISOV_345_CL_A.IsSet( 26.0f ) || FWD_RCS_TANK_ISOLATION_345_SW_CLOSE) && !(FWD_RCS_TANK_ISOLATION_345_SW_OPEN || F_FU_TK_ISOV_345_CL);// CL A
	bool K5 = (F_FU_TK_ISOV_345_CL_B.IsSet( 26.0f ) || FWD_RCS_TANK_ISOLATION_345_SW_CLOSE) && !(FWD_RCS_TANK_ISOLATION_345_SW_OPEN || F_FU_TK_ISOV_345_CL);// CL B
	...
	bool K6 = (F_OX_TK_ISOV_345_OP_A.IsSet( 26.0f ) || FWD_RCS_TANK_ISOLATION_345_SW_OPEN) && !(FWD_RCS_TANK_ISOLATION_345_SW_CLOSE || F_OX_TK_ISOV_345_OP);// OP
	bool K7 = (F_TK_ISOV_345_CL_A.IsSet( 26.0f ) || FWD_RCS_TANK_ISOLATION_345_SW_CLOSE) && !(FWD_RCS_TANK_ISOLATION_345_SW_OPEN || F_OX_TK_ISOV_345_CL);// CL A
	bool K8 = (F_OX_TK_ISOV_345_CL_B.IsSet( 26.0f ) || FWD_RCS_TANK_ISOLATION_345_SW_CLOSE) && !(FWD_RCS_TANK_ISOLATION_345_SW_OPEN || F_OX_TK_ISOV_345_CL);// CL B
	...
	// VENT DOORS
	// right 1/2 motor 1
	bool K17 = MNA_RELAY_LOGIC_POWER && (RH_VENTS_1_2_MOTOR_1_OPEN_A.IsSet( 26.0f ) && !R_VENTS_1_AND_2_OPEN_1.IsSet( 26.0f ));// OPN A
	bool K18 = MNA_RELAY_LOGIC_POWER && (RH_VENTS_1_2_MOTOR_1_OPEN_B.IsSet( 26.0f ) && !R_VENTS_1_AND_2_OPEN_1.IsSet( 26.0f ));// OPN B
	bool K19 = MNA_RELAY_LOGIC_POWER && ((RH_VENTS_1_2_MOTOR_1_CLOSE_A.IsSet( 26.0f ) || (RH_VENTS_1_2_MOTOR_1_PURGE_A.IsSet( 26.0f ) && !R_VENTS_1_AND_2_PURGE_1_IND_1.IsSet( 26.0f ))) && !R_VENTS_1_AND_2_CLOSE_1.IsSet( 26.0f ));// CLS A
	bool K20 = MNA_RELAY_LOGIC_POWER && ((RH_VENTS_1_2_MOTOR_1_CLOSE_B.IsSet( 26.0f ) || (RH_VENTS_1_2_MOTOR_1_PURGE_B.IsSet( 26.0f ) && !R_VENTS_1_AND_2_PURGE_1_IND_1.IsSet( 26.0f ))) && !R_VENTS_1_AND_2_CLOSE_1.IsSet( 26.0f ));// CLS B
