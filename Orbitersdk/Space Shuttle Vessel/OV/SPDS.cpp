...
void SPDS::DefineAnimations( void )
{
	...
	static UINT SUPPORT_OUT_Grp[2] = {GRP_SUPPORT_ASSEMBLY_OUTBOARD_SPDS, GRP_SUPPORT_ASSEMBLY_DRIVE_SPDS};
	MGROUP_ROTATE* SUPPORT_OUT_1 = new MGROUP_ROTATE( mesh_idx_SPDS[0], SUPPORT_OUT_Grp, 2, SUPPORT_ASSEMBLY_OUTBOARD_BOTTOM_AXIS_POS, SUPPORT_ASSEMBLY_AXIS_DIR, SUPPORT_ASSEMBLY_ANGLE );
	MGROUP_ROTATE* SUPPORT_OUT_2 = new MGROUP_ROTATE( mesh_idx_SPDS[1], SUPPORT_OUT_Grp, 2, SUPPORT_ASSEMBLY_OUTBOARD_BOTTOM_AXIS_POS, SUPPORT_ASSEMBLY_AXIS_DIR, SUPPORT_ASSEMBLY_ANGLE );
