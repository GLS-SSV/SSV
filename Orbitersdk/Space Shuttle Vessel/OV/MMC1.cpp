...
void MMC1::Realize( void )
{
	...
	PBD_OPERATION_ENABLE_CMD_1A.Connect( pBundle, 0 );// PBD ENABLE CMD 1A (AC1 ARM 1-MTRS)
	PBD_OPERATION_ENABLE_CMD_1B.Connect( pBundle, 1 );// PBD ENABLE CMD 1B (AC1 ARM 1-MTRS)
