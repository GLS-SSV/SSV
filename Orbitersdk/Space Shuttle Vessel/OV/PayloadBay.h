...
class PayloadBay:public AtlantisSubsystem
{
	private:
		...
		DiscOutPort PORT_FWD_RDY_LATCH_1_TM;
		DiscOutPort PORT_FWD_RDY_LATCH_2_TM;
		DiscOutPort PORT_FWD_RDY_LATCH_3_TM;
		DiscOutPort PORT_AFT_RDY_LATCH_1_TM;
		DiscOutPort PORT_AFT_RDY_LATCH_2_TM;
		DiscOutPort PORT_AFT_RDY_LATCH_3_TM;
		DiscOutPort PORT_DOOR_CLOSE_1;
		DiscOutPort PORT_DOOR_CLOSE_1_TM;
		DiscOutPort PORT_DOOR_CLOSE_2;
		DiscOutPort PORT_DOOR_CLOSE_2_TM;
		DiscOutPort PORT_DOOR_OPEN_1;
		DiscOutPort PORT_DOOR_OPEN_1_TM;
		DiscOutPort PORT_DOOR_OPEN_2;
		DiscOutPort PORT_DOOR_OPEN_2_TM;
		...
		DiscOutPort STBD_FWD_RDY_LATCH_1_TM;
		DiscOutPort STBD_FWD_RDY_LATCH_2_TM;
		DiscOutPort STBD_FWD_RDY_LATCH_3_TM;
		DiscOutPort STBD_AFT_RDY_LATCH_1_TM;
		DiscOutPort STBD_AFT_RDY_LATCH_2_TM;
		DiscOutPort STBD_AFT_RDY_LATCH_3_TM;
		DiscOutPort STBD_DOOR_CLOSE_1;
		DiscOutPort STBD_DOOR_CLOSE_1_TM;
		DiscOutPort STBD_DOOR_CLOSE_2;
		DiscOutPort STBD_DOOR_CLOSE_2_TM;
		DiscOutPort STBD_DOOR_OPEN_1;
		DiscOutPort STBD_DOOR_OPEN_1_TM;
		DiscOutPort STBD_DOOR_OPEN_2;
		DiscOutPort STBD_DOOR_OPEN_2_TM;
		...
		DiscOutPort LAT_13_16_LAT_1_TM;
		DiscOutPort LAT_13_16_LAT_2;
		DiscOutPort LAT_13_16_LAT_2_TM;
		DiscOutPort LAT_13_16_REL_1;
		DiscOutPort LAT_13_16_REL_1_TM;
		DiscOutPort LAT_13_16_REL_2;
		DiscOutPort LAT_13_16_REL_2_TM;
		...
		DiscOutPort PORT_FWD_BLKHD_LAT_1_TM;
		DiscOutPort PORT_FWD_BLKHD_LAT_2;
		DiscOutPort PORT_FWD_BLKHD_LAT_2_TM;
		DiscOutPort PORT_FWD_BLKHD_REL_1;
		DiscOutPort PORT_FWD_BLKHD_REL_1_TM;
		DiscOutPort PORT_FWD_BLKHD_REL_2;
		DiscOutPort PORT_FWD_BLKHD_REL_2_TM;
		...
		DiscOutPort PORT_AFT_BLKHD_LAT_1_TM;
		DiscOutPort PORT_AFT_BLKHD_LAT_2;
		DiscOutPort PORT_AFT_BLKHD_LAT_2_TM;
		DiscOutPort PORT_AFT_BLKHD_REL_1;
		DiscOutPort PORT_AFT_BLKHD_REL_1_TM;
		DiscOutPort PORT_AFT_BLKHD_REL_2;
		DiscOutPort PORT_AFT_BLKHD_REL_2_TM;
		...
		DiscOutPort STBD_FWD_BLKHD_LAT_1_TM;
		DiscOutPort STBD_FWD_BLKHD_LAT_2;
		DiscOutPort STBD_FWD_BLKHD_LAT_2_TM;
		DiscOutPort STBD_FWD_BLKHD_REL_1;
		DiscOutPort STBD_FWD_BLKHD_REL_1_TM;
		DiscOutPort STBD_FWD_BLKHD_REL_2;
		DiscOutPort STBD_FWD_BLKHD_REL_2_TM;
		...
		DiscOutPort STBD_AFT_BLKHD_LAT_1_TM;
		DiscOutPort STBD_AFT_BLKHD_LAT_2;
		DiscOutPort STBD_AFT_BLKHD_LAT_2_TM;
		DiscOutPort STBD_AFT_BLKHD_REL_1;
		DiscOutPort STBD_AFT_BLKHD_REL_1_TM;
		DiscOutPort STBD_AFT_BLKHD_REL_2;
		DiscOutPort STBD_AFT_BLKHD_REL_2_TM;
