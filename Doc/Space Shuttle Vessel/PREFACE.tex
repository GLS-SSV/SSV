...
\begin{multicols*}{2}
\noindent
Space Shuttle Vessel (SSV) is an addon for Orbiter Space Flight Simulator (\url{https://github.com/orbitersim/orbiter}). The purpose of this addon is to simulate NASA's Space Transportation System Program as much as possible. Currently only some elements have been completed and work on others is ongoing.

\begin{figure}[H]
	\centering
	\captionsetup{justification=centering}
	\includegraphics[width=0.99\hsize]{launch.png}
	\caption{Launch}
\end{figure}

\noindent
The basis for SSV was the Space Shuttle Ultra addon, and through additions, corrections and performance improvements it delivers a better experience for users and more capabilities for mission simulation.\\
\\
...
\\
Currently, SSV simulates a number of systems, displays, and procedures of the real shuttle and can be used along with real NASA Flight Data File (FDF) checklists to complete tasks. These checklists can be found at the NASA Flight Data Files web page (the original page has been deleted, but it was archived at \url{https://web.archive.org/web/20230530114409/http://www.nasa.gov/centers/johnson/news/flightdatafiles/index.html}), and provide a good reference for other procedures. The NASA Flight Data Files site includes checklists for all missions after STS-107, as well as generic checklists.

\begin{figure}[H]
	\centering
	\captionsetup{justification=centering}
	\includegraphics[width=0.99\hsize]{orbit.png}
	\caption{Upper stage being deployed in orbit}
\end{figure}
...
\begin{figure}[H]
	\centering
	\captionsetup{justification=centering}
	\includegraphics[width=0.99\hsize]{landing.png}
	\caption{Landing viewed from the HUD}
\end{figure}
