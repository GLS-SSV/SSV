...
The landing sites for a mission are defined in the mission file (see \ref{sec:mission-configuration} and \ref{sec:landing-sites}).
...
\noindent
SSV contains a compreensive set of those landing sites, implemented as Orbiter Simulator surface bases, allowing them to be targeted for landing.\\
The available landing sites are listed in "<Orbiter installation>\textbackslash Config\textbackslash SSV\_RunwayDB.csv", and can be viewed in the Landing tab of Mission Editor (see \ref{sec:mission-configuration}), where the landing sites for the mission can be selected.
