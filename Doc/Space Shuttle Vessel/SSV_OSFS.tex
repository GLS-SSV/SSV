...
\subsection{Options}
The file <Orbiter installation>\textbackslash Config\textbackslash Vessels\textbackslash SSV\_OV.cfg file contains parameters to control the operation of the Orbiter Vehicle vessel.\\
...
\begin{table}[H]
  ...
  \begin{tabularx}{470pt}{c | >{\centering\arraybackslash}p{50pt} | >{\centering\arraybackslash}p{300pt}}
	...
	\hline\rule{0pt}{2ex}
	AutoActions & bool & Enables Landing Gear arm and deploy, and Drag Chute deploy and jettison
	\end{tabularx}
